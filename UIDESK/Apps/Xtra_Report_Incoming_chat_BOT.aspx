<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Apps/Uidesk.Master" CodeBehind="Xtra_Report_Incoming_chat_BOT.aspx.vb" Inherits="UIDESK.Xtra_Report_Incoming_chat_BOT" %>
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0">Report Incoming Chat End BOT</h4>
            </div>
        </div>
    </div>
    <div class="row">
                        ...
                        <div class="col-md-12">
                            <dx:ASPxGridView ID="ASPxGridView1" ClientInstanceName="ASPxGridView1" DataSourceID="tempTrxStaff" runat="server" Width="100%"
                                ...
                                <Columns>
                                    ...
                                    <dx:GridViewDataColumn Caption="Page" FieldName="pageName" Width="350px"></dx:GridViewDataColumn>
                                    <dx:GridViewDataColumn Caption="Date" FieldName="date" Width="350px"></dx:GridViewDataColumn>
                                    <dx:GridViewDataColumn Caption="Total Incoming" FieldName="total_per_date" Width="350px"></dx:GridViewDataColumn>
                                </Columns>
                            </dx:ASPxGridView>
                        </div>
                    </div>
