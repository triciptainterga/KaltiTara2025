<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Apps/Uidesk.Master" CodeBehind="Crm_Trm_Inbox_EmailSystemMgr.aspx.vb" Inherits="UIDESK.Crm_Trm_Inbox_EmailSystemMgr" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script src="js/jquery-1.9.1.min.js"></script>
    <script src="js/Crm_Trm_Inbox_EmailSystemMgr.js"></script>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="Form_Ticket_Status">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row" id="ObjectEmail">
                                ...
                                <div class="col-lg-4">
                                    <div class="mb-3">
                                        <label for="workexperience-category-input">To</label>
                                        <input type="text" class="form-control" id="Form_Ticket_Email_CC" placeholder="Ccc">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
