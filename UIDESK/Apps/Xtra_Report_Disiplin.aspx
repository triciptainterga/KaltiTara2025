<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Apps/Uidesk.Master" CodeBehind="Xtra_Report_Disiplin.aspx.vb" Inherits="UIDESK.Xtra_Report_Disiplin" %>
                        ...
                        <div class="col-md-12">
                            <dx:ASPxGridView ID="ASPxGridView1" ClientInstanceName="ASPxGridView1" runat="server" Font-Size="X-Small"
                                ...
                                <Columns>
                                    ...
                                    <dx:GridViewDataTextColumn Caption="Nama" FieldName="Name" Width="40px" CellStyle-HorizontalAlign="Center"></dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="Site" FieldName="Site" Width="200px"></dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="Jumlah  Online" FieldName="IncomingChat" Width="200px"></dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="ATS" FieldName="Ats" Width="200px"></dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="ART" FieldName="Art" Width="200px"></dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="Disiplin" FieldName="Disiplin" Width="200px"></dx:GridViewDataTextColumn>
