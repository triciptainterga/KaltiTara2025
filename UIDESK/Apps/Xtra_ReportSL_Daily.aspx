<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Apps/Uidesk.Master" CodeBehind="Xtra_ReportSL_Daily.aspx.vb" Inherits="UIDESK.Xtra_ReportSL_Daily" %>
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0">Report Service Level Daily</h4>
            </div>
        </div>
    </div>
    <div class="row">
                        ...
                        <div class="col-md-12">
                            <dx:ASPxGridView ID="ASPxGridView1" ClientInstanceName="ASPxGridView1" DataSourceID="tempTrxStaff" runat="server" Width="100%"
                                ...
                                <Columns>
                                    ...
                                    <dx:GridViewDataTextColumn Caption="Tanggal" FieldName="row_date" Width="250px"></dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="Within SL" FieldName="WithinSL" Width="250px"></dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="Total Incoming" FieldName="TotalIncoming" Width="250px"></dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="ASL" FieldName="ASL" Width="250px"></dx:GridViewDataTextColumn>
