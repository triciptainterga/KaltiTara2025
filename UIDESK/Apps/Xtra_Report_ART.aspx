<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Apps/Uidesk.Master" CodeBehind="Xtra_Report_ART.aspx.vb" Inherits="UIDESK.Xtra_Report_ART" %>
                        ...
                        <div class="col-md-12">
                            <dx:ASPxGridView ID="ASPxGridView1" ClientInstanceName="ASPxGridView1" runat="server" Font-Size="X-Small"
                                ...
                                <Columns>
                                    ...
                                    <dx:GridViewDataTextColumn Caption="Kode Jadwal" FieldName="KodeJadwal" Width="200px"></dx:GridViewDataTextColumn>
