...
<ScriptService()>
<ToolboxItem(False)>
Public Class Crm_Trm_HistoryEmail1
    ...
    Public Function DataHistoryEmail(ByVal Type As String, ByVal StartDate As String, ByVal EndDate As String, ByVal Account As String, ByVal UserName As String) As String
        Dim connstring As String = ConfigurationManager.ConnectionStrings("DefaultConnection").ConnectionString
        Dim dt As DataTable = New DataTable()

        Dim NameSP = "Exec BRA_HistoryEmail"
        Dim ExecSP = "" & NameSP & " '0','" & Type & "','" & StartDate & "','" & EndDate & "','" & Account & "','" & UserName & "'"
        Try
            Using conn As SqlConnection = New SqlConnection(connstring)
                conn.Open()
                Dim sqlComm As SqlCommand = New SqlCommand("BRA_HistoryEmail", conn)
