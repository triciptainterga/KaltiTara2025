...
Public Class Tele_TrxAssign1
    ...
    <WebMethod(EnableSession:=True)>
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Function ReleaseTele(ByVal ID As String, ByVal Value As String, ByVal UserName As String, ByVal Action As String) As String
        ...
        Try
            Using con As New SqlConnection(constr)
                ...
                sqlComm.CommandText = "Tele_TrxRelease"
                sqlComm.CommandType = CommandType.StoredProcedure
        ...
        Catch ex As Exception
            ...
            strExec = "exec Tele_TrxRelease '" & ID & "','" & Value & "','" & UserName & "','" & Action & "'"
