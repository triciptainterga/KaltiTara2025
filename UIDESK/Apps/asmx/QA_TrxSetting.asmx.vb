...
Public Class QA_TrxSetting1
    ...
    <WebMethod(EnableSession:=True)>
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Function InsertSettingQA(ByVal UserID As String, ByVal CreatedBy As String, ByVal Action As String) As String
        ...
        Try
            Using con As New SqlConnection(constr)
                ...
                sqlComm.CommandText = "QA_TrxSetting"
                sqlComm.CommandType = CommandType.StoredProcedure
        ...
        Catch ex As Exception
            ...
            strExec = "exec QA_TrxSetting '" & HttpUtility.UrlDecode(UserID) & "','" & CreatedBy & "','" & Action & "'"
