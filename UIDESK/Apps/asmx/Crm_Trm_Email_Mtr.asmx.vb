...
<ScriptService()>
<ToolboxItem(False)>
Public Class Crm_Trm_Email_Mtr1
    ...
    Public Function BRA_EmailMonitoring(ByVal UserName As String) As String
        Dim connstring As String = ConfigurationManager.ConnectionStrings("DefaultConnection").ConnectionString
        Dim dt As DataTable = New DataTable()

        Dim NameSP = "Exec BRA_EmailMonitoring"
        Dim ExecSP = "" & NameSP & " '" & UserName & "'"
        Try
            Using conn As SqlConnection = New SqlConnection(connstring)
                conn.Open()
                Dim sqlComm As SqlCommand = New SqlCommand("BRA_EmailMonitoring", conn)
