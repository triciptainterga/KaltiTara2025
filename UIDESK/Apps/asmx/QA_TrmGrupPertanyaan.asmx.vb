...
<ScriptService()>
<ToolboxItem(False)>
Public Class QA_TrmGrupPertanyaan1
    ...
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Function FormAction(ByVal TrxID As String, ByVal TrxKodeAlat As String, ByVal TrxItemGroup As String, ByVal TrxBobotGroup As String, ByVal TrxTipePertanyaan As String, ByVal TrxStatus As String,
        ...
        Try
            Using con As New SqlConnection(constr)
                ...
                sqlComm.CommandText = "QM_TrmGrupPertanyaan"
                sqlComm.CommandType = CommandType.StoredProcedure
                sqlComm.Parameters.AddWithValue("TrxID", TrxID)
                sqlComm.Parameters.AddWithValue("TrxKodeAlat", TrxKodeAlat)
                sqlComm.Parameters.AddWithValue("TrxItemGroup", TrxItemGroup)
                sqlComm.Parameters.AddWithValue("TrxBobotGroup", TrxBobotGroup)
                sqlComm.Parameters.AddWithValue("TrxTipePertanyaan", TrxTipePertanyaan)
        ...
        Catch ex As Exception
            ...
            strExec = "exec QM_TrmGrupPertanyaan '" & TrxID & "','" & TrxKodeAlat & "','" & TrxItemGroup & "','" & TrxBobotGroup & "','" & TrxTipePertanyaan & "','" & TrxStatus & "','" & TrxUserName & "','" & TrxAction & "'"
        ...
        Finally
            ...
            listTickets.Add(objectTickets)
            strExec = "exec QM_TrmGrupPertanyaan '" & TrxID & "','" & TrxKodeAlat & "','" & TrxItemGroup & "','" & TrxBobotGroup & "','" & TrxStatus & "','" & TrxUserName & "','" & TrxAction & "'"
