...
<ScriptService()>
<ToolboxItem(False)>
Public Class QA_TrmMonitoringPenilaian1
    ...
    Public Function QM_TrmMonitoringPenilaian(ByVal tahun As String, ByVal bulan As String, ByVal username As String) As String
        Dim connstring As String = ConfigurationManager.ConnectionStrings("DefaultConnection").ConnectionString
        Dim dt As DataTable = New DataTable()

        Dim NameSP = "Exec QM_TrmMonitoringPenilaian"
        Dim ExecSP = "" & NameSP & " '" & tahun & "','" & bulan & "','" & username & "'"
        Try
            Using conn As SqlConnection = New SqlConnection(connstring)
                conn.Open()
                Dim sqlComm As SqlCommand = New SqlCommand("QM_TrmMonitoringPenilaian", conn)
