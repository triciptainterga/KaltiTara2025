...
Public Class ServiceCustomer1
    ...
    <WebMethod(EnableSession:=True)>
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Function BRA_Customer(ByVal TrxUsername As String, ByVal TrxCusTomerName As String, ByVal TrxCusTomerEmail As String, ByVal TrxCusTomerPhone As String,
                                 ByVal TrxCusTomerType As String, ByVal TrxCusTomerPerusahaan As String, ByVal TrxCusTomerNIK As String, ByVal TrxCusTomerAlamat As String,
                                 ByVal TrxFacebook As String, ByVal TrxInstagram As String, ByVal TrxTwitter As String, ByVal TrxNPWP As String, ByVal ContactId As String,
                                 ByVal AccountID As String) As String
        Dim TrxCustomerID As String = New Random().Next(1000000, 9999999)  'Request.QueryString("i")
        Dim listTickets As List(Of resultInsert) = New List(Of resultInsert)()
        Dim strExec As String = String.Empty
        Dim _CustomerID As String = String.Empty
        ...
        Try
            Using con As New SqlConnection(constr)
                Dim sqlComm As New SqlCommand()
                sqlComm.Connection = con
                sqlComm.CommandText = "BRA_Customer"
                sqlComm.CommandType = CommandType.StoredProcedure
                sqlComm.Parameters.AddWithValue("TrxCustomerID", TrxCustomerID)
                sqlComm.Parameters.AddWithValue("TrxUsername", TrxUsernameXSS)
                sqlComm.Parameters.AddWithValue("TrxName", HttpUtility.UrlDecode(TrxCusTomerName))
                sqlComm.Parameters.AddWithValue("TrxEmail", TrxCusTomerEmail)
                sqlComm.Parameters.AddWithValue("TrxPhone", TrxCusTomerPhone)
                sqlComm.Parameters.AddWithValue("TrxCusTomerType", TrxCusTomerType)
                sqlComm.Parameters.AddWithValue("TrxCusTomerPerusahaan", TrxCusTomerPerusahaan)
                sqlComm.Parameters.AddWithValue("TrxNIK", TrxCusTomerNIK)
                sqlComm.Parameters.AddWithValue("TrxAddress", HttpUtility.UrlDecode(TrxCusTomerAlamat))
                sqlComm.Parameters.AddWithValue("TrxFacebook", TrxFacebook)
                sqlComm.Parameters.AddWithValue("TrxInstagram", TrxInstagram)
                sqlComm.Parameters.AddWithValue("TrxTwitter", TrxTwitter)
                sqlComm.Parameters.AddWithValue("TrxNPWP", TrxNPWP)
                sqlComm.Parameters.AddWithValue("ContactId", ContactId)
                sqlComm.Parameters.AddWithValue("AccountID", AccountID)
                con.Open()
                sqldr = sqlComm.ExecuteReader()
                While sqldr.Read()
                    _Result &= sqldr("ResultNya").ToString
        ...
        Catch ex As Exception
            ...
            objectTickets.msgSystem = ex.Message()
            listTickets.Add(objectTickets)
            strExec = "exec BRA_Customer '" & TrxCustomerID & "','" & TrxUsernameXSS & "'," & "'" & HttpUtility.UrlDecode(TrxCusTomerName) & "','" & TrxCusTomerEmail & "','" & TrxCusTomerPhone & "','" & TrxCusTomerType & "','" & TrxCusTomerPerusahaan & "','" & TrxCusTomerNIK & "','" & HttpUtility.UrlDecode(TrxCusTomerAlamat) & "','" & TrxFacebook & "','" & TrxInstagram & "','" & TrxTwitter & "','" & TrxNPWP & "','" & ContactId & "','" & AccountID & "'"
            LogError(HttpContext.Current.Session("UserName"), ex, strExec)
        Finally
            Dim objectTickets As resultInsert = New resultInsert()
            If _Result = "InsertSuccess" Then
    ...
    <WebMethod(EnableSession:=True)>
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Function BRA_Customer_Fetch(ByVal TrxCustomerID As String, ByVal TrxUsername As String, ByVal TrxCusTomerName As String, ByVal TrxCusTomerEmail As String, ByVal TrxCusTomerPhone As String,
                                 ByVal TrxCusTomerType As String, ByVal TrxCusTomerPerusahaan As String, ByVal TrxCusTomerNIK As String, ByVal TrxCusTomerAlamat As String, ByVal TrxFacebook As String, ByVal TrxInstagram As String, ByVal TrxTwitter As String, ByVal TrxNPWP As String) As String
        Dim listTickets As List(Of resultInsert) = New List(Of resultInsert)()
        Dim strExec As String = String.Empty
        Dim _CustomerID As String = String.Empty
        Dim _Result As String = String.Empty
        ...
        Try
            Using con As New SqlConnection(constr)
                Dim sqlComm As New SqlCommand()
                sqlComm.Connection = con
                sqlComm.CommandText = "BRA_Customer_Fetch"
                sqlComm.CommandType = CommandType.StoredProcedure
                sqlComm.Parameters.AddWithValue("TrxCustomerID", TrxCustomerID)
                sqlComm.Parameters.AddWithValue("TrxUsername", TrxUsernameXSS)
                sqlComm.Parameters.AddWithValue("TrxName", HttpUtility.UrlDecode(TrxCusTomerName))
        ...
        Catch ex As Exception
            ...
            objectTickets.msgSystem = ex.Message()
            listTickets.Add(objectTickets)
            strExec = "exec BRA_Customer_Fetch '" & TrxCustomerID & "','" & HttpUtility.UrlDecode(TrxCusTomerName) & "','" & TrxCusTomerEmail & "','" & TrxCusTomerPhone & "','" & TrxCusTomerType & "','" & TrxCusTomerPerusahaan & "','" & TrxCusTomerNIK & "','" & TrxFacebook & "','" & TrxInstagram & "','" & TrxTwitter & "','" & TrxNPWP & "','" & HttpUtility.UrlDecode(TrxCusTomerAlamat) & "','" & TrxUsernameXSS & "'"
            LogError(HttpContext.Current.Session("UserName"), ex, strExec)
        Finally
            Dim objectTickets As resultInsert = New resultInsert()
            If _Result = "UpdateSuccess" Then
    ...
    <WebMethod(EnableSession:=True)>
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Function BRA_Kantor(ByVal TrxID As String, ByVal TrxUserName As String, ByVal TrxNama As String, ByVal TrxEmail As String, ByVal TrxTelepon As String, ByVal TrxAlamat As String, ByVal TrxAction As String) As String
        Dim TrxCustomerID As String = New Random().Next(1000000, 9999999)  'Request.QueryString("i")
        Dim listTickets As List(Of resultInsert) = New List(Of resultInsert)()
        Dim strExec As String = String.Empty
        Dim _CustomerID As String = String.Empty
        ...
        Try
            Using con As New SqlConnection(constr)
                Dim sqlComm As New SqlCommand()
                sqlComm.Connection = con
                sqlComm.CommandText = "BRA_Kantor"
                sqlComm.CommandType = CommandType.StoredProcedure
                sqlComm.Parameters.AddWithValue("TrxID", TrxID)
                sqlComm.Parameters.AddWithValue("TrxUserName", TrxUserName)
        ...
        Catch ex As Exception
            ...
            objectTickets.msgSystem = ex.Message()
            listTickets.Add(objectTickets)
            strExec = "exec BRA_Kantor '" & TrxID & "','" & TrxUsernameXSS & "','" & TrxNama & "','" & TrxEmail & "','" & TrxTelepon & "','" & TrxAlamat & "','" & TrxAction & "'"
            LogError(HttpContext.Current.Session("UserName"), ex, strExec)
        Finally
            Dim objectTickets As resultInsert = New resultInsert()
            If _Result = "InsertSuccess" Then
    ...
    <WebMethod(EnableSession:=True)>
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Function BRA_Perusahaan(ByVal TrxID As String, ByVal TrxUserName As String, ByVal TrxNama As String, ByVal TrxEmail As String, ByVal TrxTelepon As String, ByVal TrxNPWP As String, ByVal TrxAction As String, ByVal AccountId As String) As String
        Dim TrxCustomerID As String = New Random().Next(1000000, 9999999)  'Request.QueryString("i")
        Dim listTickets As List(Of resultInsert) = New List(Of resultInsert)()
        Dim strExec As String = String.Empty
        Dim _CustomerID As String = String.Empty
        ...
        Try
            Using con As New SqlConnection(constr)
                Dim sqlComm As New SqlCommand()
                sqlComm.Connection = con
                sqlComm.CommandText = "BRA_Perusahaan"
                sqlComm.CommandType = CommandType.StoredProcedure
                sqlComm.Parameters.AddWithValue("TrxID", TrxID)
                sqlComm.Parameters.AddWithValue("TrxUserName", TrxUserName)
                sqlComm.Parameters.AddWithValue("TrxNama", TrxNama)
        ...
        Catch ex As Exception
            ...
            objectTickets.msgSystem = ex.Message()
            listTickets.Add(objectTickets)
            strExec = "exec BRA_Perusahaan '" & TrxID & "','" & TrxUsernameXSS & "','" & TrxNama & "','" & TrxEmail & "','" & TrxTelepon & "','" & TrxNPWP & "','" & TrxAction & "'"
            LogError(HttpContext.Current.Session("UserName"), ex, strExec)
        Finally
            Dim objectTickets As resultInsert = New resultInsert()
            If _Result = "InsertSuccess" Then
