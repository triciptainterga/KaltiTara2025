...
<ScriptService()>
<ToolboxItem(False)>
Public Class Crm_Trm_Config_Report1
    ...
    <WebMethod(EnableSession:=True)>
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Function Insert_BRA_Configuration_Report(ByVal TrxID As String, ByVal TrxTypeReport As String, ByVal TrxTarget As String, ByVal TrxSite As String,
                                                ByVal TrxPresentase As String, ByVal TrxUserName As String) As String
        Dim listTickets As List(Of resultInsert) = New List(Of resultInsert)()
        Dim connString As String = ConfigurationManager.ConnectionStrings("DefaultConnection").ConnectionString

        Try
            Using conn As New SqlConnection(connString)
                Dim sqlComm As New SqlCommand("BRA_Configuration_Report", conn)
                sqlComm.CommandType = CommandType.StoredProcedure
                sqlComm.Parameters.AddWithValue("@TrxID", TrxID)
                sqlComm.Parameters.AddWithValue("@TrxTypeReport", TrxTypeReport)
                sqlComm.Parameters.AddWithValue("@TrxTarget", TrxTarget)
                sqlComm.Parameters.AddWithValue("@TrxSite", TrxSite)
                sqlComm.Parameters.AddWithValue("@TrxPresentase", TrxPresentase)
                sqlComm.Parameters.AddWithValue("@TrxAction", "INSERT") ' Menentukan aksi INSERT
                sqlComm.Parameters.AddWithValue("@TrxUserName", TrxUserName)
            ...
            Dim objectTickets As resultInsert = New resultInsert()
            objectTickets.Result = "True"
            objectTickets.TrxmsgSystem = "Data successfully inserted."
            listTickets.Add(objectTickets)
        ...
        Catch ex As Exception
            ...
            Dim strExec As String = "exec BRA_Configuration_Report '" & TrxID & "','" & TrxTypeReport & "','" & TrxTarget & "','" & TrxSite & "','" & TrxPresentase & "','INSERT','" & TrxUserName & "'"
            LogError(HttpContext.Current.Session("UserName"), ex, strExec)
        End Try
    ...
    <WebMethod(EnableSession:=True)>
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Function Update_BRA_Configuration_Report(ByVal TrxID As String, ByVal TrxTypeReport As String, ByVal TrxTarget As String, ByVal TrxSite As String,
                                                ByVal TrxPresentase As String, ByVal TrxUserName As String) As String
        Dim listTickets As List(Of resultInsert) = New List(Of resultInsert)()
        Dim connString As String = ConfigurationManager.ConnectionStrings("DefaultConnection").ConnectionString
        ...
        Try
            ...
            Dim objectTickets As resultInsert = New resultInsert()
            objectTickets.Result = "True"
            objectTickets.TrxmsgSystem = "Data successfully updated."
            listTickets.Add(objectTickets)
        ...
        Catch ex As Exception
            ...
            Dim strExec As String = "exec BRA_Configuration_Report '" & TrxID & "','" & TrxTypeReport & "','" & TrxTarget & "','" & TrxSite & "','" & TrxPresentase & "','UPDATE','" & TrxUserName & "'"
            LogError(HttpContext.Current.Session("UserName"), ex, strExec)
        End Try
