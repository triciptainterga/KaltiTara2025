...
<ScriptService()>
<ToolboxItem(False)>
Public Class QA_TrmItemPertanyaan1
    ...
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Function FormAction(ByVal TrxID As String, ByVal TrxKodeGroup As String, ByVal TrxItemPertanyaan As String, ByVal TrxNomorUrut As String, ByVal TrxStatus As String,
                               ByVal TrxDeskripsi As String, ByVal TrxUserName As String, ByVal TrxAction As String) As String
        ...
        Try
            Using con As New SqlConnection(constr)
                ...
                sqlComm.CommandText = "QM_TrmItemPertanyaan"
                sqlComm.CommandType = CommandType.StoredProcedure
                sqlComm.Parameters.AddWithValue("TrxID", TrxID)
                sqlComm.Parameters.AddWithValue("TrxKodeGroup", TrxKodeGroup)
                sqlComm.Parameters.AddWithValue("TrxItemPertanyaan", TrxItemPertanyaan)
                sqlComm.Parameters.AddWithValue("TrxNomorUrut", TrxNomorUrut)
                sqlComm.Parameters.AddWithValue("TrxStatus", TrxStatus)
                sqlComm.Parameters.AddWithValue("TrxDeskripsi", TrxDeskripsi)
        ...
        Catch ex As Exception
            ...
            strExec = "exec QM_TrmItemPertanyaan '" & TrxID & "','" & TrxKodeGroup & "','" & TrxItemPertanyaan & "','" & TrxNomorUrut & "','" & TrxStatus & "','" & TrxDeskripsi & "','" & TrxUserName & "','" & TrxAction & "'"
