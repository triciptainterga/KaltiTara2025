...
'Imports UIDESK.FileServiceReference
...
Public Class Crm_Trx_Ticket1
    ...
    Public Function BRA_CreateTicket(ByVal GenesysNumber As String, ByVal ThreadID As String, ByVal Account As String, ByVal Channel As String, ByVal CustomerID As String, ByVal UserName As String, ByVal Priority As String, ByVal Status As String, ByVal Subject As String,
                                     ByVal Kategori As String, ByVal SubKategori As String, ByVal NoAju As String, ByVal Kantor As String, ByVal NilaiTransaksi As String, ByVal Pertanyaan As String, ByVal Jawaban As String, ByVal Posisi As String,
                                     ByVal NamaPerusahaan As String, ByVal EmailPerusahaan As String, ByVal TeleponPerusahaan As String, ByVal NPWPPerusahaan As String, ByVal Action As String) As String
        Dim listTickets As List(Of listTransaction) = New List(Of listTransaction)()
        Dim query As String = String.Empty
        Dim constr As String = ConfigurationManager.ConnectionStrings("DefaultConnection").ConnectionString
        Dim strExec As String = String.Empty
        ...
        Try
            Using con As New SqlConnection(constr)
                ...
                sqlComm.Parameters.AddWithValue("NamaPerusahaan", NamaPerusahaan)
                sqlComm.Parameters.AddWithValue("EmailPerusahaan", EmailPerusahaan)
                sqlComm.Parameters.AddWithValue("TeleponPerusahaan", TeleponPerusahaan)
                sqlComm.Parameters.AddWithValue("NPWPPerusahaan", NPWPPerusahaan)
                sqlComm.Parameters.AddWithValue("Action", Action)
                con.Open()
                sqlComm.ExecuteNonQuery()
            End Using
        Catch ex As Exception
            ...
            objectTickets.TrxmsgSystem = ex.Message()
            listTickets.Add(objectTickets)
            strExec = "exec BRA_CreateTicket '" & strTime & "','" & StrGenesysNumber & "','" & StrThreadID & "','" & StrAccount & "','" & StrChannel & "','" & CustomerID & "','" & HttpContext.Current.Session("UserName") & "','" & Priority & "','" & Status & "','" & Subject & "','" & Kategori & "','" & SubKategori & "','" & NoAju & "','" & NilaiTransaksi & "','" & Kantor & "','" & HttpUtility.UrlDecode(Pertanyaan) & "','" & HttpUtility.UrlDecode(Jawaban) & "','" & Posisi & "','" & NamaPerusahaan & "','" & EmailPerusahaan & "','" & TeleponPerusahaan & "','" & NPWPPerusahaan & "','" & Action & "'"
            LogError(HttpContext.Current.Session("UserName"), ex, strExec)
        Finally
            Dim objectTickets As listTransaction = New listTransaction()
            objectTickets.Result = "True"
    ...
    <WebMethod(EnableSession:=True)>
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Function BRA_CreateTicketEmail(ByVal GenesysNumber As String, ByVal ThreadID As String, ByVal Account As String, ByVal Channel As String, ByVal CustomerID As String, ByVal UserName As String, ByVal Priority As String, ByVal Status As String, ByVal Subject As String,
                                     ByVal Kategori As String, ByVal SubKategori As String, ByVal NoAju As String, ByVal Kantor As String, ByVal NilaiTransaksi As String, ByVal Pertanyaan As String, ByVal Jawaban As String, ByVal Posisi As String, ByVal Tujuan As String, ByVal Cc As String, ByVal Action As String) As String
        Dim listTickets As List(Of listTransaction) = New List(Of listTransaction)()
        Dim query As String = String.Empty
        Dim constr As String = ConfigurationManager.ConnectionStrings("DefaultConnection").ConnectionString
        Dim strExec As String = String.Empty
        ...
        Try
            Using con As New SqlConnection(constr)
                Dim sqlComm As New SqlCommand()
                sqlComm.Connection = con
                sqlComm.CommandText = "BRA_CreateTicketEmail"
                sqlComm.CommandType = CommandType.StoredProcedure
                sqlComm.Parameters.AddWithValue("TicketNumber", strTime)
                sqlComm.Parameters.AddWithValue("GenesysNumber", StrGenesysNumber)
                sqlComm.Parameters.AddWithValue("ThreadID", StrThreadID)
                ...
                sqlComm.Parameters.AddWithValue("Jawaban", HttpUtility.UrlDecode(Jawaban))
                sqlComm.Parameters.AddWithValue("Posisi", Posisi)
                sqlComm.Parameters.AddWithValue("Tujuan", Tujuan)
                sqlComm.Parameters.AddWithValue("Cc", Cc)
                sqlComm.Parameters.AddWithValue("Action", Action)
                con.Open()
                sqlComm.ExecuteNonQuery()
            End Using
        Catch ex As Exception
            ...
            objectTickets.TrxmsgSystem = ex.Message()
            listTickets.Add(objectTickets)
            strExec = "exec BRA_CreateTicketEmail '" & strTime & "','" & StrGenesysNumber & "','" & StrThreadID & "','" & StrAccount & "','" & StrChannel & "','" & CustomerID & "','" & HttpContext.Current.Session("UserName") & "','" & Priority & "','" & Status & "','" & Subject & "','" & Kategori & "','" & SubKategori & "','" & NoAju & "','" & NilaiTransaksi & "','" & Kantor & "','" & HttpUtility.UrlDecode(Pertanyaan) & "','" & HttpUtility.UrlDecode(Jawaban) & "','" & Posisi & "','" & Tujuan & "','" & Cc & "','" & Action & "'"
            LogError(HttpContext.Current.Session("UserName"), ex, strExec)
        Finally
            Dim objectTickets As listTransaction = New listTransaction()
            objectTickets.Result = "True"
    ...
    <WebMethod(EnableSession:=True)>
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Function BRA_TeamLeaderEmail(ByVal TicketNumber As String, ByVal Status As String, ByVal Reason As String, ByVal ETo As String, ByVal ESubject As String,
                                        ByVal Ecc As String, ByVal UserCreate As String, ByVal Action As String) As String
        Dim listTickets As List(Of listTransaction) = New List(Of listTransaction)()
        Dim query As String = String.Empty
        Dim constr As String = ConfigurationManager.ConnectionStrings("DefaultConnection").ConnectionString
        Dim strExec As String = String.Empty
        Try
            Using con As New SqlConnection(constr)
                Dim sqlComm As New SqlCommand()
                sqlComm.Connection = con
                sqlComm.CommandText = "BRA_TeamLeaderEmail"
                sqlComm.CommandType = CommandType.StoredProcedure
                sqlComm.Parameters.AddWithValue("TicketNumber", TicketNumber)
                sqlComm.Parameters.AddWithValue("Status", Status)
                sqlComm.Parameters.AddWithValue("Reason", Reason)
                sqlComm.Parameters.AddWithValue("ETo", ETo)
                sqlComm.Parameters.AddWithValue("ESubject", ESubject)
                sqlComm.Parameters.AddWithValue("Ecc", Ecc)
        ...
        Catch ex As Exception
            ...
            objectTickets.TrxmsgSystem = ex.Message()
            listTickets.Add(objectTickets)
            strExec = "exec BRA_TeamLeaderEmail '" & TicketNumber & "','" & Status & "','" & Reason & "','" & ETo & "','" & ESubject & "','" & Ecc & "','" & UserCreate & "','" & Action & "'"
            LogError(HttpContext.Current.Session("UserName"), ex, strExec)
        Finally
            Dim objectTickets As listTransaction = New listTransaction()
            objectTickets.Result = "True"
            objectTickets.TrxTicketNumber = TicketNumber
            objectTickets.TrxmsgSystem = "Transaction Has Been Save"
            listTickets.Add(objectTickets)
            strExec = "exec BRA_TeamLeaderEmail '" & TicketNumber & "','" & Status & "','" & Reason & "','" & ETo & "','" & ESubject & "','" & Ecc & "','" & UserCreate & "','" & Action & "'"
            LogSuccess(HttpContext.Current.Session("UserName"), strExec)
    ...
    <WebMethod(EnableSession:=True)>
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Function BRA_TeamLeaderEmail_ActionTL(ByVal TicketNumber As String, ByVal Status As String, ByVal Reason As String, ByVal UserCreate As String, ByVal Action As String) As String
        Dim listTickets As List(Of listTransaction) = New List(Of listTransaction)()
        Dim query As String = String.Empty
        Dim constr As String = ConfigurationManager.ConnectionStrings("DefaultConnection").ConnectionString
        Dim strExec As String = String.Empty
        Try
            Using con As New SqlConnection(constr)
                Dim sqlComm As New SqlCommand()
                sqlComm.Connection = con
                sqlComm.CommandText = "BRA_TeamLeaderEmail_ActionTL"
                sqlComm.CommandType = CommandType.StoredProcedure
                sqlComm.Parameters.AddWithValue("TicketNumber", TicketNumber)
                sqlComm.Parameters.AddWithValue("Status", Status)
                sqlComm.Parameters.AddWithValue("Reason", Reason)
        ...
        Catch ex As Exception
            ...
            objectTickets.TrxmsgSystem = ex.Message()
            listTickets.Add(objectTickets)
            strExec = "exec BRA_TeamLeaderEmail_ActionTL '" & TicketNumber & "','" & Status & "','" & Reason & "','" & UserCreate & "','" & Action & "'"
            LogError(HttpContext.Current.Session("UserName"), ex, strExec)
        Finally
            Dim objectTickets As listTransaction = New listTransaction()
            objectTickets.Result = "True"
    ...
    <WebMethod(EnableSession:=True)>
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Function ArchieveIncomingEmail(ByVal IvcID As String, ByVal UserName As String, ByVal Action As String) As String
        Dim listTickets As List(Of resultInsert) = New List(Of resultInsert)()
        Dim strExec As String = String.Empty
        Dim constr As String = ConfigurationManager.ConnectionStrings("DefaultConnection").ConnectionString
        ...
        Try
            Using con As New SqlConnection(constr)
                Dim sqlComm As New SqlCommand()
                sqlComm.Connection = con
                sqlComm.CommandText = "BRA_ArchieveEmail"
                sqlComm.CommandType = CommandType.StoredProcedure
        ...
        Catch ex As Exception
            ...
            objectTickets.msgSystem = ex.Message()
            listTickets.Add(objectTickets)
            strExec = "exec BRA_ArchieveEmail '" & IvcID & "','" & UserName & "'," & "'" & Action & "'"
            LogError(HttpContext.Current.Session("UserName"), ex, strExec)
        Finally
            Dim objectTickets As resultInsert = New resultInsert()
            objectTickets.Result = "True"
    ...
    <WebMethod(EnableSession:=True)>
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Function BRA_TL_UpdateRedaksiEmail(ByVal TicketNumber As String, ByVal RedaksiEmail As String, ByVal UserName As String) As String
        Dim listTickets As List(Of listTransaction) = New List(Of listTransaction)()
        Dim query As String = String.Empty
        Dim constr As String = ConfigurationManager.ConnectionStrings("DefaultConnection").ConnectionString
        Dim strExec As String = String.Empty
        Try
            Using con As New SqlConnection(constr)
                Dim sqlComm As New SqlCommand()
                sqlComm.Connection = con
                sqlComm.CommandText = "BRA_TL_UpdateRedaksiEmail"
                sqlComm.CommandType = CommandType.StoredProcedure
                sqlComm.Parameters.AddWithValue("TicketNumber", TicketNumber)
                sqlComm.Parameters.AddWithValue("RedaksiEmail", RedaksiEmail)
                sqlComm.Parameters.AddWithValue("UserName", UserName)
                con.Open()
                sqlComm.ExecuteNonQuery()
            End Using
        Catch ex As Exception
            ...
            objectTickets.TrxmsgSystem = ex.Message()
            listTickets.Add(objectTickets)
            strExec = "exec BRA_TL_UpdateRedaksiEmail '" & TicketNumber & "','" & RedaksiEmail & "','" & UserName & "'"
            LogError(HttpContext.Current.Session("UserName"), ex, strExec)
        Finally
            Dim objectTickets As listTransaction = New listTransaction()
            objectTickets.Result = "True"
    ...
    <WebMethod(EnableSession:=True)>
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Function BRA_TicketDynamic(ByVal TicketUidesk As String, ByVal TicketDynamic As String) As String
        Dim listTickets As List(Of listTransaction) = New List(Of listTransaction)()
        Dim query As String = String.Empty
        Dim constr As String = ConfigurationManager.ConnectionStrings("DefaultConnection").ConnectionString
        Dim strExec As String = String.Empty
        Try
            Using con As New SqlConnection(constr)
                Dim sqlComm As New SqlCommand()
                sqlComm.Connection = con
                sqlComm.CommandText = "BRA_TicketDynamic"
                sqlComm.CommandType = CommandType.StoredProcedure
                sqlComm.Parameters.AddWithValue("TicketUidesk", TicketUidesk)
                sqlComm.Parameters.AddWithValue("TicketDynamic", TicketDynamic)
                con.Open()
                sqlComm.ExecuteNonQuery()
            End Using
        Catch ex As Exception
            ...
            objectTickets.TrxmsgSystem = ex.Message()
            listTickets.Add(objectTickets)
            strExec = "exec BRA_TicketDynamic '" & TicketUidesk & "','" & TicketDynamic & "'"
            LogError(HttpContext.Current.Session("UserName"), ex, strExec)
        Finally
            Dim objectTickets As listTransaction = New listTransaction()
            objectTickets.Result = "True"
            objectTickets.TrxTicketNumber = TicketUidesk
            objectTickets.TrxmsgSystem = "Transaction Has Been Save"
            listTickets.Add(objectTickets)
            strExec = "exec BRA_TicketDynamic '" & TicketUidesk & "','" & TicketDynamic & "'"
            LogSuccess(HttpContext.Current.Session("UserName"), strExec)
