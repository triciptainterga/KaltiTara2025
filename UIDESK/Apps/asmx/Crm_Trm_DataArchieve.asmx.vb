...
<ScriptService()>
<ToolboxItem(False)>
Public Class Crm_Trm_DataArchieve1
    ...
    Public Function InsertArchieve(ByVal ID As String, ByVal UserName As String, ByVal Name As String, ByVal Nomor As String, ByVal Action As String) As String
        ...
        Try
            Using con As New SqlConnection(constr)
                ...
                sqlComm.CommandText = "BRA_TrxMarkAsName"
                sqlComm.CommandType = CommandType.StoredProcedure
                sqlComm.Parameters.AddWithValue("ID", ID)
                sqlComm.Parameters.AddWithValue("UserName", HttpUtility.UrlDecode(UserName))
                sqlComm.Parameters.AddWithValue("Name", Name)
                sqlComm.Parameters.AddWithValue("Nomor", Nomor)
        ...
        Catch ex As Exception
            ...
            strExec = "exec BRA_TrxMarkAsName '" & ID & "','" & HttpUtility.UrlDecode(UserName) & "','" & Name & "','" & Nomor & "','" & Action & "'"
