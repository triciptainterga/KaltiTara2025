...
Public Class Tele_TrxTransaksi1
    ...
    Public Function SimpanNotes(ByVal TrxID As String, ByVal TrxNote As String,
                                ByVal TrxStatus As String, ByVal TrxReason As String, ByVal TrxTransaksi As String, ByVal TrxCreateBy As String) As String
        ...
        Try
            Using con As New SqlConnection(constr)
                ...
                sqlComm.Parameters.AddWithValue("@TrxTransaksi", TrxTransaksi)
        ...
        Catch ex As Exception
            ...
            strExec = "exec TELE_TransaksiNote '" & TrxID & "','" & TrxNote & "','" & TrxStatus & "','" & TrxReason & "','" & TrxTransaksi & "','" & TrxCreateBy & "'"
