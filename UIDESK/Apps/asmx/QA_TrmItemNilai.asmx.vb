...
Public Class QA_TrmItemNilai1
    ...
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Function FormAction(ByVal TrxID As String, ByVal TrxAlatTest As String, ByVal TrxKodeGroup As String, ByVal TrxKodePertanyaan As String, ByVal TrxNamaPenilaian As String,
                               ByVal TrxNilai As String, ByVal TrxStatus As String,
        ...
        Try
            Using con As New SqlConnection(constr)
                ...
                sqlComm.CommandText = "QM_TrmItemPenilaian"
                sqlComm.CommandType = CommandType.StoredProcedure
                sqlComm.Parameters.AddWithValue("TrxID", TrxID)
                sqlComm.Parameters.AddWithValue("TrxAlatTest", TrxAlatTest)
                sqlComm.Parameters.AddWithValue("TrxKodeGroup", TrxKodeGroup)
                sqlComm.Parameters.AddWithValue("TrxKodePertanyaan", TrxKodePertanyaan)
                sqlComm.Parameters.AddWithValue("TrxNamaPenilaian", TrxNamaPenilaian)
                sqlComm.Parameters.AddWithValue("TrxNilai", TrxNilai)
        ...
        Catch ex As Exception
            ...
            strExec = "exec QM_TrmItemPenilaian '" & TrxID & "','" & TrxAlatTest & "','" & TrxKodePertanyaan & "','" & TrxKodeGroup & "','" & TrxNamaPenilaian & "','" & TrxNilai & "','" & TrxStatus & "','" & TrxUserName & "','" & TrxAction & "'"
