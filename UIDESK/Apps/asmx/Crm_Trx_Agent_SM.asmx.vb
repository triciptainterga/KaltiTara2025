...
Public Class Crm_Trx_Agent_SM1
    ...
    Public Function InsertAgentDistributionData(ByVal TrxUserName As String, ByVal TrxData As String, ByVal TrxSosialMedia As String, ByVal TrxCampaign As String,
                                                ByVal TrxAccountName As String, ByVal MaxCampaign As String, ByVal sm_type As String) As String
        ...
        Try
            Using con As New SqlConnection(constr)
                ...
                sqlComm.Parameters.AddWithValue("TrxSosialMedia", TrxSosialMedia)
                ...
                sqlComm.Parameters.AddWithValue("sm_type", sm_type)
                con.Open()
        ...
        Catch ex As Exception
            ...
            strExec = "exec UIDESK_TrxAgentSosialMediaSettingData '" & TrxUserName & "','" & HttpUtility.UrlDecode(TrxData) & "','" & TrxSosialMedia & "','" & TrxCampaign & "','" & TrxAccountName & "','" & MaxCampaign & "','" & MaxCampaign & "'"
    ...
    <WebMethod(EnableSession:=True)>
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Function ReleaseSchedule(ByVal ID As String, ByVal TrxUserName As String, ByVal Value As String) As String
        Dim listTickets As List(Of resultInsert) = New List(Of resultInsert)()
        Dim strExec As String = String.Empty
        Dim TrxUserNameXSS As String = AntiXssEncoder.HtmlEncode(TrxUserName.Trim, True)
        Dim constr As String = ConfigurationManager.ConnectionStrings("DefaultConnection").ConnectionString
        Try
            Using con As New SqlConnection(constr)
                Dim sqlComm As New SqlCommand()
                sqlComm.Connection = con
                sqlComm.CommandText = "BRA_ReleaseSchedule"
                sqlComm.CommandType = CommandType.StoredProcedure
        ...
        Catch ex As Exception
            ...
            objectTickets.TrxmsgSystem = ex.Message()
            listTickets.Add(objectTickets)
            strExec = "exec BRA_ReleaseSchedule '" & ID & "','" & TrxUserName & "','" & Value & "'"
            LogError(HttpContext.Current.Session("UserName"), ex, strExec)
        Finally
            Dim objectTickets As resultInsert = New resultInsert()
            objectTickets.Result = "True"
    ...
    <WebMethod(EnableSession:=True)>
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Function AssignMaxHandle(ByVal ID As String, ByVal TrxUserName As String, ByVal Value As String) As String
        Dim listTickets As List(Of resultInsert) = New List(Of resultInsert)()
        Dim strExec As String = String.Empty
        Dim TrxUserNameXSS As String = AntiXssEncoder.HtmlEncode(TrxUserName.Trim, True)
        Dim constr As String = ConfigurationManager.ConnectionStrings("DefaultConnection").ConnectionString
        Try
            Using con As New SqlConnection(constr)
                Dim sqlComm As New SqlCommand()
                sqlComm.Connection = con
                sqlComm.CommandText = "BRA_AssignHandleDK"
                sqlComm.CommandType = CommandType.StoredProcedure
                sqlComm.Parameters.AddWithValue("ID", ID)
                sqlComm.Parameters.AddWithValue("TrxUserName", TrxUserName)
                sqlComm.Parameters.AddWithValue("Value", Value)
        ...
        Catch ex As Exception
            ...
            objectTickets.TrxmsgSystem = ex.Message()
            listTickets.Add(objectTickets)
            strExec = "exec BRA_AssignHandleDK '" & ID & "','" & TrxUserName & "','" & Value & "'"
            LogError(HttpContext.Current.Session("UserName"), ex, strExec)
        Finally
            Dim objectTickets As resultInsert = New resultInsert()
            objectTickets.Result = "True"
    ...
    <WebMethod(EnableSession:=True)>
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Function BRA_SearchingDigitalChannelAgent(ByVal Type As String, ByVal Value As String, ByVal UserName As String) As String
        Dim connstring As String = ConfigurationManager.ConnectionStrings("DefaultConnection").ConnectionString
        Dim dt As DataTable = New DataTable()

        Dim NameSP = "Exec BRA_SearchingDigitalChannelAgent"
        Dim ExecSP = "" & NameSP & " '" & Type & "','" & Value & "','" & UserName & "'"
        Try
            Using conn As SqlConnection = New SqlConnection(connstring)
                conn.Open()
                Dim sqlComm As SqlCommand = New SqlCommand("BRA_SearchingDigitalChannelAgent", conn)
    ...
    <WebMethod(EnableSession:=True)>
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Function ReleaseScheduleCall(ByVal ID As String, ByVal TrxUserName As String, ByVal Value As String) As String
        Dim listTickets As List(Of resultInsert) = New List(Of resultInsert)()
        Dim strExec As String = String.Empty
        Dim TrxUserNameXSS As String = AntiXssEncoder.HtmlEncode(TrxUserName.Trim, True)
        Dim constr As String = ConfigurationManager.ConnectionStrings("DefaultConnection").ConnectionString
        Try
            Using con As New SqlConnection(constr)
                Dim sqlComm As New SqlCommand()
                sqlComm.Connection = con
                sqlComm.CommandText = "BRA_ReleaseScheduleCall"
                sqlComm.CommandType = CommandType.StoredProcedure
                sqlComm.Parameters.AddWithValue("ID", ID)
                sqlComm.Parameters.AddWithValue("TrxUserName", TrxUserName)
                sqlComm.Parameters.AddWithValue("Value", Value)
        ...
        Catch ex As Exception
            ...
            objectTickets.TrxmsgSystem = ex.Message()
            listTickets.Add(objectTickets)
            strExec = "exec BRA_ReleaseScheduleCall '" & ID & "','" & TrxUserName & "','" & Value & "'"
            LogError(HttpContext.Current.Session("UserName"), ex, strExec)
        Finally
            Dim objectTickets As resultInsert = New resultInsert()
            objectTickets.Result = "True"
    ...
    <WebMethod(EnableSession:=True)>
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Function BRA_DK_UpdateMaxHandle(ByVal UserName As String, ByVal MaxHandle As String) As String
        Dim listTickets As List(Of resultDK) = New List(Of resultDK)()
        Dim strExec As String = String.Empty
        Dim constr As String = ConfigurationManager.ConnectionStrings("DefaultConnection").ConnectionString
        Try
            Using con As New SqlConnection(constr)
                Dim sqlComm As New SqlCommand()
                sqlComm.Connection = con
                sqlComm.CommandText = "BRA_DK_UpdateMaxHandle"
                sqlComm.CommandType = CommandType.StoredProcedure
                sqlComm.Parameters.AddWithValue("UserName", UserName)
                sqlComm.Parameters.AddWithValue("MaxHandle", MaxHandle)
                con.Open()
                sqlComm.ExecuteNonQuery()
                con.Close()
            End Using
        Catch ex As Exception
            ...
            objectTickets.Result = "False"
            objectTickets.TrxmsgSystem = ex.Message()
            strExec = "exec BRA_DK_UpdateMaxHandle '" & UserName & "','" & MaxHandle & "'"
            LogError(HttpContext.Current.Session("UserName"), ex, strExec)
        Finally
            Dim objectTickets As resultDK = New resultDK()
            objectTickets.Result = "True"
            listTickets.Add(objectTickets)
            strExec = "exec BRA_DK_UpdateMaxHandle '" & UserName & "','" & MaxHandle & "'"
            LogSuccess(HttpContext.Current.Session("UserName"), strExec)
