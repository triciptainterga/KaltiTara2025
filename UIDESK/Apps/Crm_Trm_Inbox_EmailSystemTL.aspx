...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="mb-3">
                                    <div class="text-end">
                                        <a class="btn btn-soft-primary w-sm" data-bs-target="#addEmailReject" id="EditRedaksi" onclick="ActionEditRedaksi()"><i class="far fa-edit"></i>&nbsp;Edit Redaksi</a>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
    ...
    <div class="modal fade bs-example-modal-xl" tabindex="-1" role="dialog" id="ModalRedaksiEmail" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true" data-bs-backdrop="static">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="addRedaksiEmail">Form Redaksi Email</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body p-4">
                    <div class="row">
                        <div class="mb-3">
                            <textarea id="RedaksiEmail" name="RedaksiEmail" class="form-control" rows="10" placeholder="Redasksi Email.."></textarea>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-light w-sm" data-bs-dismiss="modal">Close</button>
                    <button type="button" class="btn btn-primary w-sm" onclick="ActionUpdateRedaksiEmail()">Submit</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        var RedaksiEmail = CKEDITOR.replace('RedaksiEmail');
        RedaksiEmail.config.height = 500;
        RedaksiEmail.config.toolbar = 'Basic';
        RedaksiEmail.config.toolbar_Basic =
            [
                ['Bold', 'Italic', '-', 'NumberedList', 'BulletedList', '-']
            ];
    </script>
