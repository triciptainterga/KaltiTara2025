...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="modal fade bs-example-modal-xl" tabindex="-1" role="dialog" id="modal-followup"
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="myExtraLargeModalLabelfollow">Channel</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                        aria-label="Close">
                    </button>
                </div>
                <div class="modal-body">
                    <div>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <label for="workexperience-category-input">Channel</label>
                                    <select class="form-control" id="CmbSourceChannel">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <label for="workexperience-category-input">Account</label>
                                    <input type="text" class="form-control" id="Form_Channel" placeholder="Account">
                                </div>
                            </div>
                        </div>
                    </div>
