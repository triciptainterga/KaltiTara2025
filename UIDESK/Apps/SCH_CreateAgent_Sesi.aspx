<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Apps/Uidesk.Master" CodeBehind="SCH_CreateAgent_Sesi.aspx.vb" Inherits="UIDESK.SCH_CreateAgent_Sesi" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script src="js/jquery-1.9.1.min.js"></script>
    <script src="js/SCH_CreateAgent_Sesi.js"></script>
        ...
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                           <h5 class="card-title">Agent Sesi</h5>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="d-flex flex-wrap align-items-start justify-content-md-end mt-2 mt-md-0 gap-2 mb-3">
                            <div>
                                 <a href="#" class="btn btn-light" data-bs-toggle="modal" onclick="Tambah()"><i class="far fa-calendar-plus"></i> Add Sesi</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <table class="table align-middle table-nowrap table-check" id="DataSCH_Shift">
                         <thead>
                                <tr>
                                    ...
                                    <th style="width: 150px;">Date Scheduled</th>
                                    <th style="width: 150px;">Max Handle</th>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="addContactModalLabel">Create/Edit Sesi</h5>
                ...
                <div class="modal-body p-4">
                                        ...
                                        <ul class="nav nav-tabs nav-tabs-custom" role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link active" data-bs-toggle="tab" href="#shift1" role="tab">
                                                    ...
                                                    <span class="d-none d-sm-block">Create Agent Sesi</span> 
                                                </a>
                                            </li>
                                            <!--<li class="nav-item">
                                        ...
                                        <div class="tab-content p-3 text-muted">
                                            <div class="tab-pane active" id="shift1" role="tabpanel">
                                                ...
                                                <p>
                                                    Max Handle
                                                    <br />
                                                    <input type="number" id="MaxHandle" class="form-control" />
                                                </p>
                                             ...
                                             <div class="tab-pane active" id="Mondaya" role="tabpanel">
                                                   <div class="row">
                                                        <div class="col-md-12">    
                     ...
                     <div class="modal-footer">
                                                <button type="button" class="btn btn-light w-sm" data-bs-dismiss="modal">Close</button>
                                                <%--<button type="button" class="btn btn-primary w-sm" onclick="ActionUpdate()" id="Update">Update</button>--%>
                                                <a class="btn btn-primary w-sm"  onclick="SubmitDataSesi()">Add</a>
                                                <%--<button type="button" class="btn btn-primary w-sm" onclick="ActionDelete()" id="Delete">Delete</button>--%>
                                                </div>
