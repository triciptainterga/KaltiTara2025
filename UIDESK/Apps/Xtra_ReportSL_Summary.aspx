<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Apps/Uidesk.Master" CodeBehind="Xtra_ReportSL_Summary.aspx.vb" Inherits="UIDESK.Xtra_ReportSL_Summary" %>
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0">Report ASL Summary</h4>
            </div>
        </div>
    </div>
    <div class="row">
                        ...
                        <div class="col-md-12">
                            <dx:ASPxGridView ID="ASPxGridView1" ClientInstanceName="ASPxGridView1" DataSourceID="tempTrxStaff" runat="server" Width="100%"
                                ...
                                <Columns>
                                    ...
                                    <dx:GridViewDataTextColumn Caption="Site Name" FieldName="SiteName" Width="50%"></dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="Within SL" FieldName="WithinSL" Width="50%"></dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="Total Incoming" FieldName="TotalIncoming" Width="50%"></dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="ASL" FieldName="ASL" Width="50%"></dx:GridViewDataTextColumn>
