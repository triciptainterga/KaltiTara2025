<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Apps/Uidesk.Master" CodeBehind="Xtra_ReportSPA_Daily.aspx.vb" Inherits="UIDESK.Xtra_ReportSPA_Daily" %>
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0">Report SPA Daily</h4>
            </div>
        </div>
    </div>
    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <dx:ASPxGridView ID="ASPxGridView1" ClientInstanceName="ASPxGridView1" DataSourceID="tempTrxStaff" runat="server" Width="100%"
                                ...
                                <Columns>
                                    <dx:GridViewDataTextColumn Caption="Agent Name" FieldName="AgentName" Width="350px"></dx:GridViewDataTextColumn>
                                   <dx:GridViewDataTextColumn Caption="Site Name" FieldName="SiteName" Width="350px"></dx:GridViewDataTextColumn>
                                   ...
                                   <dx:GridViewDataColumn Caption="Target" FieldName="TargetNya" Width="350px"></dx:GridViewDataColumn>
                                    <dx:GridViewDataColumn Caption="Data Di Kerjakan" FieldName="DataDikerjakan" Width="350px"></dx:GridViewDataColumn>
                                    <dx:GridViewDataColumn Caption="Percentage SPA Daily" FieldName="CallPercentage" Width="350px"></dx:GridViewDataColumn>
                                    <dx:GridViewDataColumn Caption="Channel" FieldName="Channel" Width="350px"></dx:GridViewDataColumn>
                                </Columns>
                            </dx:ASPxGridView>
                        </div>
                    </div>
