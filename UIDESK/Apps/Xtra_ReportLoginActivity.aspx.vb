...
Public Class Xtra_ReportLoginActivity
    ...
    Private Sub ASPxGridView1_Init(sender As Object, e As EventArgs) Handles ASPxGridView1.Init
        'DSChannel.SelectCommand = "SELECT * FROM XtraLoginActivity WHERE UserName='" & Session("UserName") & "' ORDER BY DateLogin DESC"
        DSChannel.SelectCommand = "exec [BRA_ReportLoginActivity] '" & Session("UserName") & "'"
    End Sub
