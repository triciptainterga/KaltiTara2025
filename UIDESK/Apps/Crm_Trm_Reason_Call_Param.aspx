<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Apps/Uidesk.Master" CodeBehind="Crm_Trm_Reason_Call_Param.aspx.vb" Inherits="UIDESK.Crm_Trm_Reason_Call_Param" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <script src="js/jquery-1.9.1.min.js"></script>
    <script src="js/Crm_Trm_Reason_Call_Param.js"></script>
        ...
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            <%--<h5 class="card-title">Data Jumlah Call</h5>--%>
                        </div>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="modal-dialog modal-lg modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="addContactModalLabel">Add Parameter Jumlah Call</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                            </div>
                            <div class="modal-body p-4">
                                <div>
                                    <div class="mb-3">
                                        <label for="addcontact-name-input" class="form-label">Jumlah Call</label>
                                        <input type="text" class="form-control" id="Parameter_JumlahCall" placeholder="Jumlah Call">
                                    </div>
                                </div>
                            </div>
