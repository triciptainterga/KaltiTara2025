<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Apps/Uidesk.Master" CodeBehind="Crm_Trm_MultiChat_Mtr.aspx.vb" Inherits="UIDESK.Crm_Trm_MultiChat_Mtr" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="col-lg-12">
        <div class="row" id="multichatIframemonitoring" style="overflow-y: hidden; overflow-x: hidden;">
            <div class="col-md-12">
                <div class="iframe-container">
                    <iframe id="iframe_monitor_chat" title="description" frameborder="0" src="" class="responsive-iframe"></iframe>
                </div>
            </div>
        </div>
        <script src="js/ckeditor/ckeditor.js"></script>
        <script src="js/Crm_Trm_MultiChat_Mtr.js"></script>
        <style>
            .style1 {
                display: none;
                /*visibility: none;*/
