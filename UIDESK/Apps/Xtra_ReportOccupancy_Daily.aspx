<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Apps/Uidesk.Master" CodeBehind="Xtra_ReportOccupancy_Daily.aspx.vb" Inherits="UIDESK.Xtra_ReportOccupancy_Daily" %>
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0">Report Occupancy Rate Daily</h4>
            </div>
        </div>
    </div>
    <div class="row">
                        ...
                        <div class="col-md-12">
                            <dx:ASPxGridView ID="ASPxGridView1" ClientInstanceName="ASPxGridView1" DataSourceID="tempTrxStaff" runat="server" Width="100%"
                                ...
                                <Columns>
                                    ...
                                    <dx:GridViewDataTextColumn Caption="Handling Time Formatted" FieldName="HandlingTimeFormatted" Width="250px"></dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="Staffed Time Formatted" FieldName="StaffedTimeFormatted" Width="250px"></dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="Result" FieldName="ORRESLT" Width="250px"></dx:GridViewDataTextColumn>
