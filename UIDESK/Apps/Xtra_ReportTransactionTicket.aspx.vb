...
Public Class Xtra_ReportTransactionTicket
    ...
    Private Sub btn_Submit_Click(sender As Object, e As EventArgs) Handles btn_Submit.Click
        Dim queryInsert As String = "exec [BRA_Report_Transaction_28042025] '" & Session("UserName") & "','" & Format(dt_strdate.Value, "yyyy-MM-dd") & "','" & Format(dt_endate.Value, "yyyy-MM-dd") & "'"
        ...
        Catch ex As Exception
            Response.Write(DirectCast(ex.Message() & "_exec [BRA_Report_Transaction_28042025] '" & Session("UserName") & "','" & Format(dt_strdate.Value, "yyyy-MM-dd") & "','" & Format(dt_endate.Value, "yyyy-MM-dd") & "'", String))
        End Try
    ...
    Private Sub ASPxGridView1_Init(sender As Object, e As EventArgs) Handles ASPxGridView1.Init
        ...
        TempBaseTrx.SelectCommand = "exec [BRA_Report_Transaction_Query] '" & Session("UserName") & "'"
    End Sub
    ...
    Private Sub btn_Export_Click(sender As Object, e As EventArgs) Handles btn_Export.Click
        ...
        Select Case casses
            ...
            Case "Word"
                ASPxGridViewExporter1.WriteDocxToResponse("ReportBaseTrx_" & DateTime.Now.ToString("yyyyMMddhhmmss"))
        End Select
    End Sub
