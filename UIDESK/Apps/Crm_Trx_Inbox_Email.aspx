<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Apps/Uidesk.Master" CodeBehind="Crm_Trx_Inbox_Email.aspx.vb" Inherits="UIDESK.Crm_Trx_Inbox_Email" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <link href="css/alertify.css" rel="stylesheet" />
    <link href="css/alertify.min.css" rel="stylesheet" />
    <script src="js/jquery-1.9.1.min.js"></script>
    <script src="js/Crm_Trx_Inbox_Email.js"></script>
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="email-rightbar mb-3">
                    <div class="card">
                        <div class="card-body" id="DivInboxEmail">
