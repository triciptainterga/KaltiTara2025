<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Apps/Uidesk.Master" CodeBehind="Xtra_ReportKualitasDetail.aspx.vb" Inherits="UIDESK.Xtra_ReportKualitasDetail" %>
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0">Report Kualitas Detail</h4>
            </div>
        </div>
    </div>
    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <dx:ASPxGridView ID="ASPxGridView1" ClientInstanceName="ASPxGridView1" DataSourceID="tempTrxStaff" runat="server" Width="100%"
                                Font-Size="14px" Styles-Header-Font-Bold="true" Theme="MetropolisBlue" KeyFieldName="header_id"
                                ...
                                <Columns>
                                    <dx:GridViewDataTextColumn Caption="ID Penilaian" FieldName="header_id" Width="250px"></dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="SiteName" FieldName="sitename" Width="250px"></dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="Penilai" FieldName="qaname" Width="250px"></dx:GridViewDataTextColumn>
                                    ...
                                    <dx:GridViewDataTextColumn Caption="Aspek Callmon" FieldName="itemgroup" Width="250px"></dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="Detail Aspek Callmon" FieldName="itempertanyaan" Width="250px"></dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="Nilai" FieldName="nilai" Width="250px"></dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="Nilai Maksimal" FieldName="nilaimaksimal" Width="250px"></dx:GridViewDataTextColumn>
                                    <dx:GridViewDataDateColumn Caption="Date Penilaian" FieldName="createddate" Width="250px" PropertiesDateEdit-DisplayFormatString="yyyy-MM-dd hh:mm:ss"></dx:GridViewDataDateColumn>
                                    <dx:GridViewDataDateColumn Caption="Date Sampling" FieldName="waktuinteraksi" Width="250px" PropertiesDateEdit-DisplayFormatString="yyyy-MM-dd hh:mm:ss"></dx:GridViewDataDateColumn>
                                </Columns>
                                <Templates>
                                    <DetailRow>
