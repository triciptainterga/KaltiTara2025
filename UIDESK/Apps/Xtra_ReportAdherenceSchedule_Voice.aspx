<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Apps/Uidesk.Master" CodeBehind="Xtra_ReportAdherenceSchedule_Voice.aspx.vb" Inherits="UIDESK.Xtra_ReportAdherenceSchedule_Voice" %>
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0">Report ART Voice</h4>
            </div>
        </div>
    </div>
    <div class="row">
                        ...
                        <div class="col-md-12">
                            <dx:ASPxGridView ID="ASPxGridView1" ClientInstanceName="ASPxGridView1" DataSourceID="tempTrxStaff" runat="server" Width="100%"
                                ...
                                <Columns>
                                    ...
                                    <dx:GridViewDataColumn Caption="Ring Time" FieldName="RingTime" Width="250px"></dx:GridViewDataColumn>
                                    <dx:GridViewDataColumn Caption="Acd Time" FieldName="AcdTime" Width="250px"></dx:GridViewDataColumn>
                                    <dx:GridViewDataColumn Caption="Acd Calls" FieldName="AcdCalls" Width="250px"></dx:GridViewDataColumn>
                                    <dx:GridViewDataColumn Caption="Avg Ring Time" FieldName="AvgRingTime" Width="250px"></dx:GridViewDataColumn>
                                    <dx:GridViewDataColumn Caption="Avg Ring Time Raw" FieldName="AvgRingTimeRaw" Width="250px"></dx:GridViewDataColumn>
                                    <dx:GridViewDataColumn Caption="Param Voice" FieldName="ParamVoice" Width="250px"></dx:GridViewDataColumn>
                                    <dx:GridViewDataColumn Caption="Selisih Ring Time" FieldName="SelisihRingTime" Width="250px"></dx:GridViewDataColumn>
                                    <dx:GridViewDataColumn Caption="Mengurangi" FieldName="Mengurangi" Width="250px"></dx:GridViewDataColumn>
