<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Apps/Uidesk.Master" CodeBehind="Out_TrxAgent.aspx.vb" Inherits="UIDESK.Out_TrxAgent" %>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                <h5 class="card-title">Setting Agent Outbound Call</h5>
                            </div>
                        </div>
                        <div class="col-md-6">
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary w-sm" onclick="SubmitDelete()" id="Delete">Delete</button>
                </div>
            </div>
        </div>
    </div>
