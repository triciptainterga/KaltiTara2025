<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Apps/Uidesk.Master" CodeBehind="Exp_DCT.aspx.vb" Inherits="UIDESK.Exp_DCT" %>
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0">Data Kategori Ticket</h4>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                            <dx:ASPxGridView ID="ASPxGridView1" ClientInstanceName="ASPxGridView1" runat="server" Font-Size="X-Small"
                                ...
                                <Columns>
                                    <dx:GridViewDataTextColumn Caption="Name" FieldName="Name" Width="25%"></dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="SubName" FieldName="SubName" Width="25%"></dx:GridViewDataTextColumn>
                                    <dx:GridViewDataDateColumn Caption="Date Created" FieldName="DateCreate" Width="25%" PropertiesDateEdit-DisplayFormatString="yyyy-MM-dd"></dx:GridViewDataDateColumn>
                                    <dx:GridViewDataTextColumn Caption="User Name" FieldName="UserNameNya" Width="25%"></dx:GridViewDataTextColumn>
                                </Columns>
                            </dx:ASPxGridView>
                        </div>
                    </div>
                    ...
                    <asp:SqlDataSource ID="DSource" ConnectionString="<%$ ConnectionStrings:DefaultConnection %>" runat="server">
                    </asp:SqlDataSource>
                </div>
            </div>
        </div>
