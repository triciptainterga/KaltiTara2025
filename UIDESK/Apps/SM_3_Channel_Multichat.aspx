<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Apps/Uidesk.Master" CodeBehind="SM_3_Channel_Multichat.aspx.vb" Inherits="UIDESK.SM_3_Channel_Multichat" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <%--<script src="https://code.jquery.com/jquery-1.9.1.min.js"></script>--%>
    <script src="js/jquery-1.9.1.min.js"></script>
    <script src="js/sweetalert.min.js"></script>
    <script src="js/SM_3_Channel_Multichat.js"></script>
   <%-- <div class="col-lg-12">
        <div class="card">
            <div class="card-body">
