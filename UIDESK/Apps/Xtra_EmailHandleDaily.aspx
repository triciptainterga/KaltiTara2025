<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Apps/Uidesk.Master" CodeBehind="Xtra_EmailHandleDaily.aspx.vb" Inherits="UIDESK.Xtra_EmailHandleDaily" %>
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0">Report Email Total Daily Handle</h4>
            </div>
        </div>
    </div>
    <div class="row">
