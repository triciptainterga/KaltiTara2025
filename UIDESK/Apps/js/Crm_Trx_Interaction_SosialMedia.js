...
function showDivContent(flagto) {
    if (flagto == "msg" || getParameterByName('mid') == "3031") {
        ...
        document.getElementById("iframe_channel").src = urlDatakelola + "chat/view?with-header=0&with-sidebar=0&with-footer=0&token=" + $("#SM_MultiChatToken").val();
        ...
        //getWS_GetDataListMessage(getParameterByName('flagto'), getParameterByName('agentlogin'));
    } else if (flagto == "PagesInteraction") {
        //Model Chat Conversation
        // $("#messagesDiv").hide();
        ...
        document.getElementById("iframe_channel").src = "view/pagesinteraction.html?agentid=" + $("#hd_sessionLogin").val();
        //getWS_GetDataListMessage(getParameterByName('flagto'), getParameterByName('agentlogin'));
