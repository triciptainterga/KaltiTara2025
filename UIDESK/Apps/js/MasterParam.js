...
function LIstData() {
    ...
    $.ajax({
        ...
        data: "{TrxID:'0', TrxUserName: '" + $("#hd_sessionLogin").val() + "', TrxAction: 'MASTER', TrxActionType: 'ListGroup'}",
        ...
        success: function (data) {
            ...
            for (i = 0; i < json.length; i++) {
                ...
                myTable.row.add([json[i].ID, json[i].GroupType, json[i].ChannelName, json[i].QtyAgent, buttonAction]).draw(false);
            }
...
function viewData(id) {
    ...
    $.ajax({
        type: "POST",
        url: "asmx/SCH_CreateShifts.asmx/UIDESK_TrmMasterTransaction",
        data: "{TrxID:'" + id +"', TrxUserName: '" + $("#hd_sessionLogin").val() + "', TrxAction: 'MASTER', TrxActionType: 'ListGroupById'}",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (data) {
            ...
            for (i = 0; i < json.length; i++) {
                $('#hfId').val(json[i].ID);
                $('#mySelect').val(json[i].GroupName);
                $('#SelectDataChannel').val(json[i].ChannelName);
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                ...
                data: "{TrxID:'" + id + "', TrxUserName: '', TrxAction: '', TrxActionType: 'DELETE', Param1: '', Param2: '', Param3: '', Param4: ''}",
...
function ActionSave() {
    ...
    if ($("#mySelect").val() == "") {
        swal(
            '',
            'Group Agent Tidak boleh kosong.',
            'info'
        ).then(function () {
            return false;
        });
    ...
    $.ajax({
        ...
        data: "{TrxID:'" + $('#mySelect').val() + "', TrxUserName: '" + $('#SelectDataChannel').val() + "', TrxAction: '', TrxActionType: 'InsertData', Param1: '" + $('#Qty').val() + "', Param2: '', Param3: '', Param4: ''}",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (data) {
...
function ActionUpdate() {
    ...
    $.ajax({
        ...
        data: "{TrxID:'" + $('#mySelect').val() + "', TrxUserName: '" + $('#SelectDataChannel').val() + "', TrxAction: '', TrxActionType: 'UpdateData', Param1: '" + $('#Qty').val() + "', Param2: '" + $('#hfId').val() + "', Param3: '', Param4: ''}",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (data) {
