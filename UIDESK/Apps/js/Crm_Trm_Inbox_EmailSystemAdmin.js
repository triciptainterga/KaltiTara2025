...
function OnclickSendMail() {
    ...
    $('#filterDateContainerSendEmail').show();
}
...
function OnclickArchieve() {
    ...
    $('#filterDateContainerArchieve').show();
}
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            for (var i = 0; i < json.length; i++) {
                ...
                var EFROM, subject, DateRead, SiteName, NameNya;
                if (json[i].Reading == 0 || json[i].Reading == null) {
                    ...
                    SiteName = "<a href='#' onclick=Click_ReadingEmail('" + json[i].IVC_ID + "','" + json[i].EMAIL_ID + "','" + json[i].EFROM + "')><b>" + json[i].SiteNameNya + "</b></a>";
                    NameNya = "<a href='#' onclick=Click_ReadingEmail('" + json[i].IVC_ID + "','" + json[i].EMAIL_ID + "','" + json[i].EFROM + "')><b>" + json[i].NameNya + "</b></a>";
                    ...
                    SiteName = "<a href='#' onclick=Click_ReadingEmail('" + json[i].IVC_ID + "','" + json[i].EMAIL_ID + "','" + json[i].EFROM + "')>" + json[i].SiteNameNya + "</a>";
                    NameNya = "<a href='#' onclick=Click_ReadingEmail('" + json[i].IVC_ID + "','" + json[i].EMAIL_ID + "','" + json[i].EFROM + "')>" + json[i].NameNya + "</a>";
                ...
                if (SiteName == "" || SiteName == null) {
                    ...
                    var SiteNameNya = SiteName
                }
                myTable.row.add([SiteNameNya, EFROM, subject, NameNya, ResponseStatus, DateRead, DateRead]).draw(false);
            }
        },
        error: function (xmlHttpRequest, textStatus, errorThrown) {
            console.log(xmlHttpRequest.responseText);
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            for (i = 0; i < json.length; i++) {
                ...
                var subject = "<a href='#' onclick=Click_ReadingTicket('" + json[i].IVC_ID + "','" + json[i].EMAIL_ID + "','" + json[i].TicketNumber + "')>" + json[i].ESUBJECT.substring(0, 20) + "..</a>"
                var DateRead = "<a href='#' onclick=Click_ReadingTicket('" + json[i].IVC_ID + "','" + json[i].EMAIL_ID + "','" + json[i].TicketNumber + "')>" + newDate + ' ' + newTime + "</a>"
                myTable.row.add([json[i].SiteNameNya, EFROM, subject, json[i].PICTujuanNya, DateRead]).draw(false);
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            for (i = 0; i < json.length; i++) {
                ...
                var subject = "<a href='#'  onclick=Click_ReadingTicket('" + json[i].IVC_ID + "','" + json[i].EMAIL_ID + "','" + json[i].TicketNumber + "')>" + json[i].ESUBJECT + "</a>"
                var DateRead = "<a href='#'  onclick=Click_ReadingTicket('" + json[i].IVC_ID + "','" + json[i].EMAIL_ID + "','" + json[i].TicketNumber + "')>" + newDate + ' ' + newTime + "</a>"
                myTable.row.add([json[i].SiteNameNya,EFROM, subject, TujuanNya, DateRead]).draw(false);
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            for (i = 0; i < json.length; i++) {
                ...
                var EFROM, subject, DateRead, SiteName, NameNya;
                if (json[i].Reading == 0 || json[i].Reading == null) {
                    SiteName = "<a href='#' onclick=Click_ReadingEmail('" + json[i].IVC_ID + "','" + json[i].EMAIL_ID + "','" + json[i].EFROM + "')><b>" + json[i].KantorSite + "</b></a>";
                    NameNya = "<a href='#' onclick=Click_ReadingEmail('" + json[i].IVC_ID + "','" + json[i].EMAIL_ID + "','" + json[i].EFROM + "')><b>" + json[i].NameNya + "</b></a>";
                    ...
                    SiteName = "<a href='#' onclick=Click_ReadingEmail('" + json[i].IVC_ID + "','" + json[i].EMAIL_ID + "','" + json[i].EFROM + "')>" + json[i].KantorSite + "</a>";
                    NameNya = "<a href='#' onclick=Click_ReadingEmail('" + json[i].IVC_ID + "','" + json[i].EMAIL_ID + "','" + json[i].EFROM + "')>" + json[i].NameNya + "</a>";
                ...
                myTable.row.add([SiteName, EFROM, subject, NameNya, "<span class='badge rounded-pill badge-soft-danger font-size-12'>" + json[i].DIRECTION + "</span>", DateRead]).draw(false);
...
function SaveTemplate() {
    ...
    var JawabaNyaAgent = CKEDITOR.instances.Ticket_NoteAgent.setData();
...
function ActionGetTemplate() {
    $("#FormTemplate").modal('hide');
    var JawabaNyaAgent = CKEDITOR.instances.Template_Description.setData();
    ...
    swal({
        ...
        .then((willDelete) => {
            if (willDelete) {
                ...
                var form_data = JSON.stringify({
                    TrxID: $("#ContentPlaceHolder1_TrxPerusahaanID").val(), TrxUserName: $("#hd_sessionLogin").val(), TrxNama: $("#Perusahaan_Nama").val(), TrxEmail: $("#AddPerusahaan_Type").val(), TrxTelepon: "-", TrxNPWP: $("#Perusahaan_NPWP").val(), TrxAction: "UPDATE"
                });
                $.ajax({
                    type: "POST",
                    url: "asmx/ServiceCustomer.asmx/BRA_Perusahaan",
