<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Apps/Uidesk.Master" CodeBehind="Xtra_ReportAverageRingTime.aspx.vb" Inherits="UIDESK.Xtra_ReportAverageRingTime" %>
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0">Report Average Ring Time</h4>
            </div>
        </div>
    </div>
    <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <dx:ASPxCheckBox Width="10%" ID="Channel" runat="server" Text="Enable Channel" AutoPostBack="true" OnCheckedChanged="Channel_CheckedChanged" Visible="false" />
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <dx:ASPxGridView ID="ASPxGridView1" ClientInstanceName="ASPxGridView1" DataSourceID="tempTrxStaff" runat="server" Width="100%"
                                ...
                                <Settings ShowFilterRow="true" ShowFilterRowMenu="true" ShowGroupPanel="true" ShowVerticalScrollBar="false" ShowHorizontalScrollBar="true" />
                                <Columns>
                                    <dx:GridViewDataTextColumn Caption="Agent Name" FieldName="NamaAgent" Width="25%"></dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="Site" FieldName="SiteName" Width="25%"></dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="Average Ring Time" FieldName="RingTime" Width="25%"></dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="Standar" FieldName="Standar" Width="25%"></dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="Report" FieldName="Report" Width="25%"></dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="Nilai Report" FieldName="NilaiReport" Width="25%"></dx:GridViewDataTextColumn>
