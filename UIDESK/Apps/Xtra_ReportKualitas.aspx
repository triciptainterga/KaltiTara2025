<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Apps/Uidesk.Master" CodeBehind="Xtra_ReportKualitas.aspx.vb" Inherits="UIDESK.Xtra_ReportKualitas" %>
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0">Report Kualitas</h4>
            </div>
        </div>
    </div>
    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <dx:ASPxGridView ID="ASPxGridView1" ClientInstanceName="ASPxGridView1" DataSourceID="tempTrxStaff" runat="server" Width="100%"
                                ...
                                <Columns>
                                    <dx:GridViewDataTextColumn Caption="ID Penilaian" FieldName="HeaderID" Width="250px" HeaderStyle-HorizontalAlign="Left" CellStyle-HorizontalAlign="Left"></dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="SiteName" FieldName="SiteName" Width="250px"></dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="Penilai" FieldName="qa_fullname" Width="250px"></dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="Agent Name" FieldName="Agent_name" Width="250px"></dx:GridViewDataTextColumn>
                                    ...
                                    <dx:GridViewDataTextColumn Caption="Kriteria" FieldName="Kriteria" Width="250px"></dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="Skor" FieldName="summary_skor" Width="250px"></dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="Catatan" FieldName="keterangan" Width="500px" CellStyle-HorizontalAlign="Left" PropertiesTextEdit-EncodeHtml="false"></dx:GridViewDataTextColumn>
                                    <dx:GridViewDataDateColumn Caption="Date Penilaian" FieldName="created_date" Width="250px" PropertiesDateEdit-DisplayFormatString="yyyy-MM-dd hh:mm:ss"></dx:GridViewDataDateColumn>
                                    <dx:GridViewDataDateColumn Caption="Date Sampling" FieldName="waktu_interaksi" Width="250px" PropertiesDateEdit-DisplayFormatString="yyyy-MM-dd hh:mm:ss"></dx:GridViewDataDateColumn>
                                </Columns>
                                <Templates>
                                    <DetailRow>
