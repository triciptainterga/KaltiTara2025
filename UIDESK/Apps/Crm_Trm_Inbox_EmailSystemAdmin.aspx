<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Apps/Uidesk.Master" CodeBehind="Crm_Trm_Inbox_EmailSystemAdmin.aspx.vb" Inherits="UIDESK.Crm_Trm_Inbox_EmailSystemAdm" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script src="js/jquery-1.9.1.min.js"></script>
    <script src="js/Crm_Trm_Inbox_EmailSystemAdmin.js"></script>
            ...
            <div class="email-rightbar mb-3">
                ...
                <div class="card" id="DivTableIncomingEmail">
                    <div class="card-body">
                        ...
                        <div id="filterDateContainerArchieve" style="display: none; float: right;">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row" id="DivRejectTeamLeader">
                                <%--<div class="col-lg-12">
                                    <div class="mb-3">
                                        <textarea id="RejectTeamLeader" style="width: 100%; border-color: red;" rows="8"></textarea>
                                    </div>
                                </div>--%>
