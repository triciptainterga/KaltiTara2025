<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Apps/Uidesk.Master" CodeBehind="Xtra_ReportSummaryMultichat.aspx.vb" Inherits="UIDESK.Xtra_ReportSummaryMultichat" %>
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0">Report Summary Multichat</h4>
            </div>
        </div>
    </div>
    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <dx:ASPxGridView ID="ASPxGridView1" ClientInstanceName="ASPxGridView1" runat="server" Font-Size="X-Small"
                                ...
                                <Columns>
                                   <dx:GridViewDataDateColumn Caption="Tanggal" FieldName="Tanggal" Width="150px" PropertiesDateEdit-DisplayFormatString="yyyy-MM-dd"></dx:GridViewDataDateColumn>                                  
								  <dx:GridViewDataTextColumn Caption="Incoming Chat" FieldName="IncomingChat" Width="200px"></dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="Answer Chat" FieldName="AnswerChat" Width="200px"></dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="Abandon Chat" FieldName="AbandonChat" Width="200px"></dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="After Office Hour" FieldName="total_other_chat" Width="200px"></dx:GridViewDataTextColumn>
