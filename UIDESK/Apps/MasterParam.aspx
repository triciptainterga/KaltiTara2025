<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Apps/Uidesk.Master" CodeBehind="MasterParam.aspx.vb" Inherits="UIDESK.MasterParam" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script src="js/jquery-1.9.1.min.js"></script>
    <script src="js/MasterParam.js"></script>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content p-4"> <!-- Add padding here -->
            <div class="row">
                ...
                <div class="col-12 col-md-4 mb-3">
                    ...
                    <div class="input-group">
                        <select id="SelectDataChannel" name="options" class="form-control">
