<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Apps/Uidesk.Master" CodeBehind="Xtra_EmailFRM.aspx.vb" Inherits="UIDESK.Xtra_EmailFRM" %>
                    ...
                    <div class="row">
                        <dx:ASPxGridView ID="ASPxGridView1" ClientInstanceName="ASPxGridView1" DataSourceID="tempTrxEmail" runat="server" Width="100%"
                            ...
                            <Columns>
                                ...
                                <dx:GridViewDataDateColumn Caption="Email Date " FieldName="Email_Date" Width="250px" PropertiesDateEdit-DisplayFormatString="yyyy-MM-dd HH:mm:ss:fff"></dx:GridViewDataDateColumn>
                                <dx:GridViewDataDateColumn Caption="Email Blanding" FieldName="DATE_BLENDING" Width="250px" PropertiesDateEdit-DisplayFormatString="yyyy-MM-dd HH:mm:ss:fff"></dx:GridViewDataDateColumn>
                                <dx:GridViewDataTextColumn Caption="Email Read" FieldName="Email_Date" Width="250px"></dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="Email Response" FieldName="Email_Date" Width="250px"></dx:GridViewDataTextColumn>
