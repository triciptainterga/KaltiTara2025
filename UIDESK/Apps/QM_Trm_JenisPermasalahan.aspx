<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Apps/Uidesk.Master" CodeBehind="QM_Trm_JenisPermasalahan.aspx.vb" Inherits="UIDESK.QM_Trm_JenisPermasalahan" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script src="js/jquery-1.9.1.min.js"></script>
    <script src="js/QM_Trm_JenisPermasalahan.js"></script>
