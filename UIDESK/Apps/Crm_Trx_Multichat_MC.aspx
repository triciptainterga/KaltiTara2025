<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Apps/Uidesk.Master" CodeBehind="Crm_Trx_Multichat_MC.aspx.vb" Inherits="UIDESK.Crm_Trx_Multichat_MC" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script src="js/Crm_Trx_Multichat_MC.js"></script>
    <script src="js/sweetalert.min.js"></script>
     <asp:HiddenField ID="TrxID" runat="server" />
    <asp:HiddenField ID="TrxID_DK" runat="server" />
    ...
    <asp:HiddenField ID="TrxAccountID" runat="server" />
    <asp:HiddenField ID="TrxTokenMetaAgent" runat="server" />
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0">Agent Setting Handle</h4>
            </div>
        </div>
    </div>
    <div class="row">
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="myExtraLargeModalLabel">Form Setting Agent Multichat</h5>
    ...
    <!-- Modal untuk Release Omni -->
    <div class="modal fade" id="modal-release-omni" tabindex="-1" aria-labelledby="addContactModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="addContactModalRelease">Form Release Omni</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body p-4">
                    <div>
                        <div class="mb-3">
                            <label for="addcontact-designation-input" class="form-label">Max Handle</label>
                            <select class="form-select" id="CmbHandling">
                                <option>Select</option>
                            </select>
                        </div>
                    </div>
    ...
    <!-- Modal untuk Release DK -->
    <div class="modal fade" id="modal-release-dk" tabindex="-1" aria-labelledby="addContactModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="addContactModalRelease">Release DK</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body p-4">
                    <div>
                        <div class="mb-3">
                            <label for="addcontact-designation-input" class="form-label">Max Handle</label>
                            <select class="form-select" id="ComboReleaseDK">
                                <option>Select</option>
                                <option>0</option>
                                <option>3</option>
                            </select>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-light w-sm" data-bs-dismiss="modal">Close</button>
                    <button type="button" class="btn btn-primary w-sm" onclick="ActionReleaseScheduleDK()" id="ReleaseScheduleDK">Submit</button>
                </div>
            </div>
        </div>
    </div>
