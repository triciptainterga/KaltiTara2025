<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Apps/Uidesk.Master" CodeBehind="QM_Report_Penilaian_Call_ScoreCard_Detail.aspx.vb" Inherits="UIDESK.QM_Report_Penilaian_Call_ScoreCard_Detail" %>
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0">Report Penilaian Call By Aspek Detail Callmon</h4>
            </div>
        </div>
    </div>
    <div class="row">
                            ...
                            <dx:ASPxGridView ID="ASPxGridView1" ClientInstanceName="ASPxGridView1" DataSourceID="tempTrxStaff" runat="server" Width="100%"
                                ...
                                <Settings ShowFilterRow="true" ShowFilterRowMenu="false" ShowGroupPanel="true" ShowVerticalScrollBar="false" ShowHorizontalScrollBar="true" />
                                 <Columns>
                                    ...
                                    <dx:GridViewDataTextColumn Caption="Aspek Callmon" FieldName="AspekCallmon" Width="250px"></dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="Detail Aspek Callmon" FieldName="DetailAspekCallmon" Width="250px"></dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="Caption Answer" FieldName="NoteAnswer" Width="250px"></dx:GridViewDataTextColumn>
