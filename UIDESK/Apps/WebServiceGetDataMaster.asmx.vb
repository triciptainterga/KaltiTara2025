...
Public Class WebServiceGetDataMaster
    ...
    Public Function InsertTransactionTrmCategory(ByVal TrxUserName As String, ByVal TrxName As String, ByVal TrxStatus As String) As String
        ...
        Catch ex As Exception
            ...
            strExec = "exec UIDESK_TrxCategory '0','" & UserNameXSS & "','" & NameXSS & "','" & TrxStatus & "','" & TrxAction & "'"
    ...
    Public Function TableTransactionTrmGroupAgent(ByVal TrxUserName As String) As String
        ...
        Try
            Using conn As SqlConnection = New SqlConnection(connstring)
                ...
                sqlComm.Parameters.AddWithValue("@TrxID", "-")
                sqlComm.Parameters.AddWithValue("@TrxUserName", TrxUserName)
                sqlComm.Parameters.AddWithValue("TrxSite", "0")
                sqlComm.Parameters.AddWithValue("@TrxName", "0")
                sqlComm.Parameters.AddWithValue("@TrxStatus", "0")
                sqlComm.Parameters.AddWithValue("@TrxAction", TrxAction)
                sqlComm.CommandType = CommandType.StoredProcedure
    ...
    <WebMethod(EnableSession:=True)>
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Function SelectTransactionTrmGroupAgent(ByVal TrxID As String, ByVal TrxUserName As String, ByVal TrxSite As String, ByVal TrxName As String, ByVal TrxStatus As String, ByVal TrxAction As String) As String
        Dim connstring As String = ConfigurationManager.ConnectionStrings("DefaultConnection").ConnectionString
        Dim dt As DataTable = New DataTable()
    ...
    <WebMethod(EnableSession:=True)>
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Function InsertTransactionTrmGroupAgent(ByVal TrxUserName As String, ByVal TrxSite As String, ByVal TrxName As String, ByVal TrxStatus As String) As String
        Dim listTickets As List(Of resultInsert) = New List(Of resultInsert)()
        Dim strExec As String = String.Empty
        Dim _Valuenya As String = String.Empty
        Dim _Result As String = String.Empty
        ...
        Catch ex As Exception
            ...
            objectTickets.TrxmsgSystem = ex.Message()
            listTickets.Add(objectTickets)
            strExec = "exec UIDESK_TrxGroupAgent '0','" & UserNameXSS & "','" & TrxSite & "','" & AntiXssEncoder.HtmlEncode(TrxName.Trim, True) & "','" & TrxStatus & "','" & TrxAction & "'"
            LogError(HttpContext.Current.Session("UserName"), ex, strExec)
        Finally
            Dim objectTickets As resultInsert = New resultInsert()
            If _Result = "Success" Then
    ...
    <WebMethod(EnableSession:=True)>
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Function UpdateTransactionTrmGroupAgent(ByVal TrxID As String, ByVal TrxUserName As String, ByVal TrxSite As String, ByVal TrxName As String, ByVal TrxStatus As String) As String
        Dim listTickets As List(Of resultInsert) = New List(Of resultInsert)()
        Dim strExec As String = String.Empty
        Dim _Valuenya As String = String.Empty
        Dim _Result As String = String.Empty
        ...
        Catch ex As Exception
            ...
            objectTickets.TrxmsgSystem = ex.Message()
            listTickets.Add(objectTickets)
            strExec = "exec UIDESK_TrxGroupAgent '" & TrxID & "','" & UserNameXSS & "','" & TrxSite & "','" & AntiXssEncoder.HtmlEncode(TrxName.Trim, True) & "','" & TrxStatus & "','" & TrxAction & "'"
            LogError(HttpContext.Current.Session("UserName"), ex, strExec)
        Finally
            Dim objectTickets As resultInsert = New resultInsert()
            If _Result = "Success" Then
    ...
    Public Function TableTransactionTrmSettingUser(ByVal LevelUserID As String, ByVal TrxUserName As String) As String
        ...
        Try
            Using conn As SqlConnection = New SqlConnection(connstring)
                ...
                sqlComm.Parameters.AddWithValue("@TrxID", "0")
                sqlComm.Parameters.AddWithValue("TrxSystem", "0")
    ...
    <WebMethod(EnableSession:=True)>
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Function InsertTransactionTrmSettingUser(ByVal TrxSystem As String, ByVal TrxMenuID As String, ByVal TrxSubMenuID As String, ByVal TrxTreeMenuID As String, ByVal TrxDescription As String,
        ...
        Try
            Using con As New SqlConnection(constr)
                ...
                sqlComm.CommandType = CommandType.StoredProcedure
                sqlComm.Parameters.AddWithValue("TrxID", "0")
                sqlComm.Parameters.AddWithValue("TrxSystem", TrxSystem)
        ...
        Catch ex As Exception
            ...
            objectTickets.TrxmsgSystem = ex.Message()
            listTickets.Add(objectTickets)
            strExec = "exec UIDESK_TrxSettingManagement '0','" & TrxSystem & "','" & TrxMenuID & "','" & TrxSubMenuID & "','" & TrxTreeMenuID & "','" & AntiXssEncoder.HtmlEncode(TrxDescription.Trim, True) & "','" & UserNameXSS & "','" & TrxLevelUserID & "','" & TrxAction & "'"
            LogError(HttpContext.Current.Session("UserName"), ex, strExec)
        Finally
            Dim objectTickets As resultInsert = New resultInsert()
            If _Result = "Success" Then
    ...
    <WebMethod(EnableSession:=True)>
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Function InsertTransactionUserApplication(ByVal TrxUserName As String, ByVal TrxName As String, ByVal TrxNIP As String, ByVal TrxPassword As String,
                                                     ...
                                                     ByVal TrxChannelTwitter As String, ByVal TrxLoginID As String, ByVal TrxTokenMeta As String) As String
        Dim listTickets As List(Of resultInsert) = New List(Of resultInsert)()
        Dim strExec As String = String.Empty
        Dim _Valuenya As String = String.Empty
        Dim _Result As String = String.Empty
        ...
        Try
            Using con As New SqlConnection(constr)
                ...
                sqlComm.Parameters.AddWithValue("TrxNIP", TrxNIP)
        ...
        Catch ex As Exception
            ...
            objectTickets.TrxmsgSystem = ex.Message()
            listTickets.Add(objectTickets)
            strExec = "exec UIDESK_TrxUser '0','" & TrxUserNameXSS & "','" & TrxNameXSS & "','" & TrxNIP & "','" & TrxPassword & "','" & TrxLevelUser & "','" & TrxDepartment & "','" & TrxGroupAgent & "','" & TrxSite & "','" & TrxDescription & "','" & TrxStatus & "','" & TrxUserCreate & "','" & TrxChannelEmail & "','" & TrxChannelWA & "','" & TrxChannelInbound & "','" & TrxChannelOutbound & "','" & TrxChannelInstagram & "','" & TrxChannelFacebook & "','" & TrxChannelTwitter & "','" & TrxLoginID & "','" & TrxTokenMeta & "','" & TrxAction & "'"
            LogError(HttpContext.Current.Session("UserName"), ex, strExec)
        Finally
            Dim objectTickets As resultInsert = New resultInsert()
            If _Result = "Success" Then
    ...
    <WebMethod(EnableSession:=True)>
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Function UpdateTransactionUserApplication(ByVal TrxID As String, ByVal TrxUserName As String, ByVal TrxName As String, ByVal TrxNIP As String, ByVal TrxPassword As String,
                                                     ByVal TrxLevelUser As String, ByVal TrxDepartment As String, ByVal TrxGroupAgent As String, ByVal TrxSite As String,
                                                     ByVal TrxDescription As String, ByVal TrxStatus As String, ByVal TrxUserCreate As String,
        ...
        Catch ex As Exception
            ...
            objectTickets.TrxmsgSystem = ex.Message()
            listTickets.Add(objectTickets)
            strExec = "exec UIDESK_TrxUser '" & TrxID & "','" & AntiXssEncoder.HtmlEncode(TrxUserName.Trim, True) & "','" & AntiXssEncoder.HtmlEncode(TrxName.Trim, True) & "','" & TrxNIP & "','" & TrxPassword & "','" & TrxLevelUser & "','" & TrxDepartment & "','" & TrxGroupAgent & "','" & TrxDescriptionValue & "','" & TrxStatus & "','" & TrxUserCreate & "','" & TrxChannelEmail & "','" & TrxChannelWA & "','" & TrxChannelInbound & "','" & TrxChannelOutbound & "','" & TrxChannelInstagram & "','" & TrxChannelFacebook & "','" & TrxChannelTwitter & "','" & TrxLoginID & "','" & TrxTokenMeta & "','" & TrxAction & "'"
            LogError(HttpContext.Current.Session("UserName"), ex, strExec)
        Finally
            Dim objectTickets As resultInsert = New resultInsert()
            If _Result = "Success" Then
    ...
    Public Function DeleteTransactionUserApplication(ByVal TrxID As String, ByVal TrxUserCreate As String) As String
        ...
        Try
            Using con As New SqlConnection(constr)
                ...
                sqlComm.Parameters.AddWithValue("TrxUserName", "0")
                sqlComm.Parameters.AddWithValue("TrxName", "0")
                sqlComm.Parameters.AddWithValue("TrxNIP", "0")
                ...
                sqlComm.Parameters.AddWithValue("TrxLoginID", "0")
                sqlComm.Parameters.AddWithValue("TrxAction", TrxAction)
                con.Open()
                sqldr = sqlComm.ExecuteReader()
                While sqldr.Read()
    ...
    <WebMethod(EnableSession:=True)>
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Function InsertTransactionSubMenuApplication(ByVal TrxMenuName As String, ByVal TrxSubMenuName As String, ByVal TrxUrl As String, ByVal Icon As String, ByVal TrxType As String) As String
        Dim listTickets As List(Of resultInsert) = New List(Of resultInsert)()
        Dim strExec As String = String.Empty
        Dim _Valuenya As String = String.Empty
        Dim _Result As String = String.Empty
        ...
        Try
            Using con As New SqlConnection(constr)
                ...
                sqlComm.Parameters.AddWithValue("TrxUrl", HttpUtility.UrlDecode(TrxUrl))
                sqlComm.Parameters.AddWithValue("Icon", Icon)
                sqlComm.Parameters.AddWithValue("TrxType", TrxType)
                sqlComm.Parameters.AddWithValue("TrxAction", TrxAction)
                con.Open()
                sqldr = sqlComm.ExecuteReader()
    ...
    <WebMethod(EnableSession:=True)>
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Function UpdateTransactionSubMenuApplication(ByVal TrxID As String, ByVal TrxSubMenuName As String, ByVal TrxUrl As String, ByVal Icon As String, ByVal TrxType As String) As String
        Dim listTickets As List(Of resultInsert) = New List(Of resultInsert)()
        Dim strExec As String = String.Empty
        Dim _Valuenya As String = String.Empty
        Dim _Result As String = String.Empty
    ...
    <WebMethod(EnableSession:=True)>
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Function InsertTransactionDetailMenuApplication(ByVal TrxMenuName As String, ByVal TrxSubMenuName As String, ByVal TrxDetailMenuName As String, ByVal TrxUrl As String, ByVal Icon As String, ByVal TrxType As String) As String
        Dim listTickets As List(Of resultInsert) = New List(Of resultInsert)()
        Dim strExec As String = String.Empty
        Dim _Valuenya As String = String.Empty
        Dim _Result As String = String.Empty
    ...
    <WebMethod(EnableSession:=True)>
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Function UpdateTransactionDetailMenuApplication(ByVal TrxID As String, ByVal TrxDetailMenuName As String, ByVal TrxUrl As String, ByVal Icon As String, ByVal TrxType As String) As String
        Dim listTickets As List(Of resultInsert) = New List(Of resultInsert)()
        Dim strExec As String = String.Empty
        Dim _Valuenya As String = String.Empty
        Dim _Result As String = String.Empty
    ...
    Public Function DeleteTransactionDetailMenuApplication(ByVal TrxID As String) As String
        ...
        Try
            Using con As New SqlConnection(constr)
                ...
                sqlComm.Parameters.AddWithValue("TrxUrl", "0")
                sqlComm.Parameters.AddWithValue("Icon", "0")
                sqlComm.Parameters.AddWithValue("TrxType", "0")
                sqlComm.Parameters.AddWithValue("TrxAction", TrxAction)
                con.Open()
                sqldr = sqlComm.ExecuteReader()
    ...
    <WebMethod(EnableSession:=True)>
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Async Function SendTicketDataAsync(ByVal NamaKantor As String, ByVal NamaKategory As String, ByVal NamaSubCategory As String, ByVal AccountId As String, ByVal ContactId As String, ByVal Origin As String, ByVal Priority As String,
                                            ByVal Judul As String, ByVal NoTicket As String, ByVal description As String) As Task(Of String)
        ...
        '        sqlComm.CommandType = CommandType.StoredProcedure
        '        sqlComm.Parameters.AddWithValue("TrxID", NoTicket)
        '        sqlComm.Parameters.AddWithValue("TrxUserName", "0")
        '        sqlComm.Parameters.AddWithValue("TrxAction", "UIDESK218")
        '        con.Open()
        '        sqldr = sqlComm.ExecuteReader()
        '        While sqldr.Read()
        '            StrPath &= sqldr("Path").ToString
        '        End While
        '        sqldr.Close()
        '        con.Close()
        '    End Using
        'Catch ex As Exception
        '    LogError(HttpContext.Current.Session("UserName"), ex, "UIDESK218")
        'Finally
        '    LogSuccess(HttpContext.Current.Session("UserName"), "UIDESK218")
        'End Try

        ' Define the API endpoint
        Dim apiUrl As String = "http://10.102.51.51:82/api/case" ' Replace with your API endpoint
        ' Create an anonymous object with the data
        Dim ticketData = New With {
        Key .NamaKantor = NamaKantor,
        Key .NamaKategory = NamaKategory,
        Key .NamaSubCategory = NamaSubCategory,
        ...
        'Dim jsonData As String = JsonConvert.SerializeObject(ticketData)
        '' Create the content to be sent with the request
        'Dim content As New StringContent(jsonData, Encoding.UTF8, "application/json")
        '' Use HttpClient to send a POST request with the JSON content
        ...
        Dim jsonData As String = JsonConvert.SerializeObject(ticketData)
        Dim content As New StringContent(jsonData, Encoding.UTF8, "application/json")
        LogSuccess(HttpContext.Current.Session("UserName"), jsonData)
        Try
            ' Menggunakan HttpClient untuk mengirim permintaan POST dengan konten JSON
            Using client As New HttpClient()
                Dim response As HttpResponseMessage = Await client.PostAsync(apiUrl, content)
                response.EnsureSuccessStatusCode() ' Melempar pengecualian jika kode status bukan 2xx
                Dim responseData As String = Await response.Content.ReadAsStringAsync()
        ...
        Catch ex As HttpRequestException
            ' Menangani kesalahan terkait permintaan HTTP (misalnya masalah jaringan, server tidak ditemukan)
            LogError(HttpContext.Current.Session("UserName"), ex, ex.Message)
            Return $"Terjadi kesalahan saat mengirim permintaan: {ex.Message}"
        Catch ex As Exception
    ...
    <WebMethod(EnableSession:=True)>
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Async Function CreateDataContact(ByVal BusinessPhone As String, ByVal Email As String, ByVal FacebookId As String, ByVal TwitterId As String, ByVal InstagramId As String, ByVal Name As String) As Task(Of String)
        ' Define the API endpoint
        Dim apiUrl As String = "http://10.102.51.51:82/api/contact"

        ' Create an anonymous object with the data
        Dim ticketData = New With {
        Key .BusinessPhone = BusinessPhone,
        Key .Email = Email,
        ...
        Using client As New HttpClient()
            ...
            'Dim datasArray As JArray = CType(jsonObject("Datas"), JArray)
    ...
    <WebMethod(EnableSession:=True)>
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Async Function GetAllDataContact() As Task(Of String)

        Dim apiUrl As String = "http://10.102.51.51:82/api/contactall?year=3" ' Replace with your API endpoint
        ...
        Using client As New HttpClient()
            ...
            Dim storedProcedureName As String = "InsertContact"
            ...
            Using connection As New SqlConnection(ConfigurationManager.ConnectionStrings("DefaultConnection").ConnectionString)
                ...
                For Each item As JObject In datasArray
                    Dim ContactId As String = item("ContactId").ToString()
                    Dim name As String = item("Name").ToString()
                    Dim businessPhone As String = item("BusinessPhone").ToString()
                    Dim email As String = item("Email").ToString()
                    Dim FacebookId As String = item("FacebookId").ToString()
                    Dim InstagramId As String = item("InstagramId").ToString()
                    Dim TwitterId As String = item("TwitterId").ToString()
                    ...
                    Using command As New SqlCommand(storedProcedureName, connection)
                        ...
                        command.Parameters.AddWithValue("@BusinessPhone", businessPhone)
                        command.Parameters.AddWithValue("@Email", email)
                        command.Parameters.AddWithValue("@FacebookId", FacebookId)
                        command.Parameters.AddWithValue("@InstagramId", InstagramId)
    ...
    <WebMethod(EnableSession:=True)>
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Async Function GetAllDataKantor() As Task(Of String)

        Dim apiUrl As String = "http://10.102.51.51:82/api/accountall?year=10"
        ...
        Using client As New HttpClient()
            ...
            Dim storedProcedureName As String = "InsertDataKantorDynamic"
            ...
            Using connection As New SqlConnection(ConfigurationManager.ConnectionStrings("DefaultConnection").ConnectionString)
                ...
                For Each item As JObject In datasArray
                    ...
                    Dim MainPhone As String = item("MainPhone").ToString()
                    Dim NPWP As String = item("NPWP").ToString()
                    Dim email As String = item("Email").ToString()
                    Dim AccountId As String = item("AccountId").ToString()
                    ...
                    Using command As New SqlCommand(storedProcedureName, connection)
                        ...
                        command.Parameters.AddWithValue("@MainPhone", MainPhone)
                        command.Parameters.AddWithValue("@NPWP", NPWP)
                        command.Parameters.AddWithValue("@Email", email)
    ...
    <WebMethod(EnableSession:=True)>
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Async Function CreateDataAccount(ByVal AccountName As String, ByVal MainPhone As String, ByVal NPWP As String, ByVal Email As String, ByVal ContactId As String) As Task(Of String)
        ' Define the API endpoint
        Dim apiUrl As String = "http://10.102.51.51:82/api/account"


        Dim ticketData = New With {
        Key .AccountName = AccountName,
        Key .MainPhone = MainPhone,
        Key .NPWP = NPWP,
        Key .Email = Email,
        Key .ContactId = ContactId
        }
    ...
    Public Function LogMessage(ByVal logData As String) As String
        Try
            ...
            Dim logFilePath As String = "~/apps/ErrorLog/log.txt"
    ...
    <WebMethod(EnableSession:=True)>
    <ScriptMethod(UseHttpGet:=False, ResponseFormat:=ResponseFormat.Json)>
    Public Function BRA_Dash_Performance(ByVal UserName As String, ByVal Action As String) As String
        Dim connstring As String = ConfigurationManager.ConnectionStrings("DefaultConnection").ConnectionString
        Dim dt As DataTable = New DataTable()

        Dim NameSP = "Exec BRA_Dash_Performance"
        Dim ExecSP = "" & NameSP & " '" & UserName & "','" & Action & "'"
        Try
            Using conn As SqlConnection = New SqlConnection(connstring)
                conn.Open()
                Dim sqlComm As SqlCommand = New SqlCommand("BRA_Dash_Performance", conn)
