<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Apps/Uidesk.Master" CodeBehind="Xtra_EmailRFT.aspx.vb" Inherits="UIDESK.Xtra_EmailRFT" %>
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0">Report Email Response Time</h4>
            </div>
        </div>
    </div>
    <div class="row">
                    ...
                    <div class="row">
                        <dx:ASPxGridView ID="ASPxGridView1" ClientInstanceName="ASPxGridView1" DataSourceID="tempTrxEmail" runat="server" Width="100%"
                            ...
                            <Columns>
                                ...
                                <dx:GridViewDataDateColumn Caption="Email Date Received" FieldName="DateReceived" Width="250px" PropertiesDateEdit-DisplayFormatString="yyyy-MM-dd HH:mm:ss"></dx:GridViewDataDateColumn>
