<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Apps/Uidesk.Master" CodeBehind="Xtra_ReportSPA_Summary.aspx.vb" Inherits="UIDESK.Xtra_ReportSPA_Summary" %>
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0">Report SPA Summary</h4>
            </div>
        </div>
    </div>
    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <dx:ASPxGridView ID="ASPxGridView1" ClientInstanceName="ASPxGridView1" DataSourceID="tempTrxStaff" runat="server" Width="100%"
                                ...
                                <Columns>
                                    <dx:GridViewDataTextColumn Caption="Agent Name" FieldName="AgentName" Width="50%"></dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="Site" FieldName="SiteName" Width="50%"></dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="Target" FieldName="Target" Width="50%"></dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="Data Dikerjakan" FieldName="DataDikerjakan" Width="50%"></dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="Total" FieldName="TotalPercentage" Width="50%"></dx:GridViewDataTextColumn>
