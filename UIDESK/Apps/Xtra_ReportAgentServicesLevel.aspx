<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Apps/Uidesk.Master" CodeBehind="Xtra_ReportAgentServicesLevel.aspx.vb" Inherits="UIDESK.Xtra_ReportAgentServicesLevel" %>
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0">Report Agent Service Level</h4>
            </div>
        </div>
    </div>
    <div class="row">
                    ...
                    <div class="row">
                        <dx:ASPxGridView ID="ASPxGridView1" ClientInstanceName="ASPxGridView1" DataSourceID="tempTrxEmail" runat="server" Width="100%"
                           ...
                           <Columns>
                            ...
                            <dx:GridViewDataTextColumn Caption="Staffed" FieldName="Staffed" Width="200px"></dx:GridViewDataTextColumn>
