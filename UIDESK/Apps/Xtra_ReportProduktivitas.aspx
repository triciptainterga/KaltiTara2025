<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Apps/Uidesk.Master" CodeBehind="Xtra_ReportProduktivitas.aspx.vb" Inherits="UIDESK.Xtra_ReportProduktivitas" %>
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0">Report Produktivitas</h4>
            </div>
        </div>
    </div>
    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <dx:ASPxGridView ID="ASPxGridView1" ClientInstanceName="ASPxGridView1" DataSourceID="tempTrxStaff" runat="server" Width="100%"
                                ...
                                <Columns>
                                    <dx:GridViewDataTextColumn Caption="Nama Agent" FieldName="NamaAgent"  Width="50%"></dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="Site" FieldName="SiteName" Width="50%"></dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="Occupancy Rate" FieldName="OccupancyRate" Width="50%"></dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="Service Per Agent" FieldName="ServicePerAgent" Width="50%"></dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="Agent Service Level" FieldName="AgentServiceLevel" Width="50%"></dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn Caption="Nilai Produktivitas" FieldName="NilaiProduktivitas" Width="50%"></dx:GridViewDataTextColumn>
