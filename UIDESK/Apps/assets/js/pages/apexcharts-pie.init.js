var options = {
    ...
    labels: ["Puas", "Tidak Puas", "Sangat Puas", "Tidak Survey"],
    legend: {
        position: "bottom"
    },
    dataLabels: {
    ...
    options = ((chart = new ApexCharts(document.querySelector("#simple_dount_chart"), options)).render(), {
        series: [44, 55, 13, 33],
        chart: {
            height: 280,
            type: "donut"
...
options = {
    ...
    colors: ["#038edc", "#51d28c", "#f7cc53", "#f34e4e", "#564ab1"]
}, (chart = new ApexCharts(document.querySelector("#gradient_chart"), options)).render(), options = {
    series: [44, 55, 41, 17, 15],
    chart: {
        height: 300,
        type: "donut",
    ...
    colors: ["#038edc", "#51d28c", "#f7cc53", "#f34e4e", "#564ab1"]
}, (chart = new ApexCharts(document.querySelector("#pattern_chart"), options)).render(), options = {
    series: [44, 33, 54, 45],
    chart: {
        height: 300,
        type: "pie"
...
}, (chart = new ApexCharts(document.querySelector("#image_pie_chart"), options)).render(), options = {
