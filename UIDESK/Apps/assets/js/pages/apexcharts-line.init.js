var options = {
    ...
    options = ((chart = new ApexCharts(document.querySelector("#line_chart_zoomable"), options)).render(), {
        chart: {
            height: 380,
            type: "line",
            zoom: {
    ...
    options = ((chart = new ApexCharts(document.querySelector("#line_chart_datalabel"), options)).render(), {
        chart: {
            height: 380,
            type: "line",
            zoom: {
    ...
    options = ((chart = new ApexCharts(document.querySelector("#line_chart_annotations"), options)).render(), {
        series: [{
    ...
    optionsArea = ((chart = new ApexCharts(document.querySelector("#syncingchart-line"), options)).render(), {
        series: [{
            data: generateDayWiseTimeSeries(new Date("11 Feb 2017").getTime(), 20, {
                min: 10,
                max: 60
...
var options = {
    ...
    optionsLine = ((chart = new ApexCharts(document.querySelector("#brushchart_line2"), options)).render(), {
        series: [{
            data: data
        }],
        chart: {
    ...
    options = ((chart = new ApexCharts(document.querySelector("#line_chart_stepline"), options)).render(), {
        series: [{
            name: "Likes",
    ...
    options = ((chart = new ApexCharts(document.querySelector("#line_chart_gradient"), options)).render(), {
        series: [{
            name: "Peter",
    ...
    lastDate = ((chart = new ApexCharts(document.querySelector("#line_chart_missing_data"), options)).render(), 0),
    data = [],
    TICKINTERVAL = 864e5,
    XAXISRANGE = 7776e5;
